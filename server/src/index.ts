...
server.tool(
  ...
  {
    action: z.enum(['register', 'list', 'info', 'reindex', 'merge', 'scan_ghosts', 'migrate', 'link', 'export_pending', 'generate_focused_workspace', 'list_focused_workspaces']).describe('The action to perform'),
