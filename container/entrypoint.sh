...
PM_RUNNING_IN_CONTAINER="${PM_RUNNING_IN_CONTAINER:-true}"
...
if ! echo "${PM_INTERACTIVE_TERMINAL_HOST_PORT}" | grep -Eq '^[0-9]+$'; then
  echo "[entrypoint] WARNING: Invalid PM_INTERACTIVE_TERMINAL_HOST_PORT='${PM_INTERACTIVE_TERMINAL_HOST_PORT}', defaulting to 45459"
  PM_INTERACTIVE_TERMINAL_HOST_PORT="45459"
fi

if ! echo "${PM_INTERACTIVE_TERMINAL_CONNECT_TIMEOUT_MS}" | grep -Eq '^[0-9]+$'; then
  echo "[entrypoint] WARNING: Invalid PM_INTERACTIVE_TERMINAL_CONNECT_TIMEOUT_MS='${PM_INTERACTIVE_TERMINAL_CONNECT_TIMEOUT_MS}', defaulting to 3000"
  PM_INTERACTIVE_TERMINAL_CONNECT_TIMEOUT_MS="3000"
fi

if ! echo "${PM_INTERACTIVE_TERMINAL_REQUEST_TIMEOUT_MS}" | grep -Eq '^[0-9]+$'; then
  echo "[entrypoint] WARNING: Invalid PM_INTERACTIVE_TERMINAL_REQUEST_TIMEOUT_MS='${PM_INTERACTIVE_TERMINAL_REQUEST_TIMEOUT_MS}', defaulting to 30000"
  PM_INTERACTIVE_TERMINAL_REQUEST_TIMEOUT_MS="30000"
fi

export MBS_DATA_ROOT MBS_AGENTS_ROOT PM_RUNNING_IN_CONTAINER PM_TERM_ADAPTER_MODE
export PM_INTERACTIVE_TERMINAL_HOST_ALIAS PM_INTERACTIVE_TERMINAL_HOST_FALLBACK_ALIAS
export PM_INTERACTIVE_TERMINAL_HOST_PORT PM_INTERACTIVE_TERMINAL_CONNECT_TIMEOUT_MS
export PM_INTERACTIVE_TERMINAL_REQUEST_TIMEOUT_MS PM_INTERACTIVE_TERMINAL_TRACE_BRIDGE
...
echo "  IT bridge mode:  ${PM_TERM_ADAPTER_MODE} (container=${PM_RUNNING_IN_CONTAINER})"
echo "  IT bridge host:  ${PM_INTERACTIVE_TERMINAL_HOST_ALIAS}:${PM_INTERACTIVE_TERMINAL_HOST_PORT}"
echo "  IT bridge fallbk:${PM_INTERACTIVE_TERMINAL_HOST_FALLBACK_ALIAS}:${PM_INTERACTIVE_TERMINAL_HOST_PORT}"
echo "  IT bridge t/o:   connect=${PM_INTERACTIVE_TERMINAL_CONNECT_TIMEOUT_MS}ms request=${PM_INTERACTIVE_TERMINAL_REQUEST_TIMEOUT_MS}ms"
echo "================================="
