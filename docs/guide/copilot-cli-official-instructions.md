...
* **Hooks**: Hooks allow you to execute custom shell commands at key points during agent execution, enabling you to add validation, logging, security scanning, or workflow automation. See [About hooks](/en/copilot/concepts/agents/coding-agent/about-hooks).
...
For more information, see [Copilot CLI ACP server](/en/copilot/reference/acp-server).
