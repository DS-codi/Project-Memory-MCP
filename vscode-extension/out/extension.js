"use strict";var er=Object.create;var dt=Object.defineProperty;var tr=Object.getOwnPropertyDescriptor;var sr=Object.getOwnPropertyNames;var nr=Object.getPrototypeOf,or=Object.prototype.hasOwnProperty;var O=(s,e)=>()=>(e||s((e={exports:{}}).exports,e),e.exports),rr=(s,e)=>{for(var t in e)dt(s,t,{get:e[t],enumerable:!0})},zs=(s,e,t,n)=>{if(e&&typeof e=="object"||typeof e=="function")for(let o of sr(e))!or.call(s,o)&&o!==t&&dt(s,o,{get:()=>e[o],enumerable:!(n=tr(e,o))||n.enumerable});return s};var G=(s,e,t)=>(t=s!=null?er(nr(s)):{},zs(e||!s||!s.__esModule?dt(t,"default",{value:s,enumerable:!0}):t,s)),ir=s=>zs(dt({},"__esModule",{value:!0}),s);var We=O((Ec,Js)=>{"use strict";var cr=require("path"),we="\\\\/",Ys=`[^${we}]`,be="\\.",lr="\\+",dr="\\?",ut="\\/",pr="(?=.)",Qs="[^/]",Ut=`(?:${ut}|$)`,Xs=`(?:^|${ut})`,Gt=`${be}{1,2}${Ut}`,ur=`(?!${be})`,hr=`(?!${Xs}${Gt})`,fr=`(?!${be}{0,1}${Ut})`,gr=`(?!${Gt})`,mr=`[^.${ut}]`,wr=`${Qs}*?`,Zs={DOT_LITERAL:be,PLUS_LITERAL:lr,QMARK_LITERAL:dr,SLASH_LITERAL:ut,ONE_CHAR:pr,QMARK:Qs,END_ANCHOR:Ut,DOTS_SLASH:Gt,NO_DOT:ur,NO_DOTS:hr,NO_DOT_SLASH:fr,NO_DOTS_SLASH:gr,QMARK_NO_DOT:mr,STAR:wr,START_ANCHOR:Xs},vr={...Zs,SLASH_LITERAL:`[${we}]`,QMARK:Ys,STAR:`${Ys}*?`,DOTS_SLASH:`${be}{1,2}(?:[${we}]|$)`,NO_DOT:`(?!${be})`,NO_DOTS:`(?!(?:^|[${we}])${be}{1,2}(?:[${we}]|$))`,NO_DOT_SLASH:`(?!${be}{0,1}(?:[${we}]|$))`,NO_DOTS_SLASH:`(?!${be}{1,2}(?:[${we}]|$))`,QMARK_NO_DOT:`[^.${we}]`,START_ANCHOR:`(?:^|[${we}])`,END_ANCHOR:`(?:[${we}]|$)`},yr={alnum:"a-zA-Z0-9",alpha:"a-zA-Z",ascii:"\\x00-\\x7F",blank:" \\t",cntrl:"\\x00-\\x1F\\x7F",digit:"0-9",graph:"\\x21-\\x7E",lower:"a-z",print:"\\x20-\\x7E ",punct:"\\-!\"#$%&'()\\*+,./:;<=>?@[\\]^_`{|}~",space:" \\t\\r\\n\\v\\f",upper:"A-Z",word:"A-Za-z0-9_",xdigit:"A-Fa-f0-9"};Js.exports={MAX_LENGTH:1024*64,POSIX_REGEX_SOURCE:yr,REGEX_BACKSLASH:/\\(?![*+?^${}(|)[\]])/g,REGEX_NON_SPECIAL_CHARS:/^[^@![\].,$*+?^{}()|\\/]+/,REGEX_SPECIAL_CHARS:/[-*+?.^${}(|)[\]]/,REGEX_SPECIAL_CHARS_BACKREF:/(\\?)((\W)(\3*))/g,REGEX_SPECIAL_CHARS_GLOBAL:/([-*+?.^${}(|)[\]])/g,REGEX_REMOVE_BACKSLASH:/(?:\[.*?[^\\]\]|\\(?=.))/g,REPLACEMENTS:{"***":"*","**/**":"**","**/**/**":"**"},CHAR_0:48,CHAR_9:57,CHAR_UPPERCASE_A:65,CHAR_LOWERCASE_A:97,CHAR_UPPERCASE_Z:90,CHAR_LOWERCASE_Z:122,CHAR_LEFT_PARENTHESES:40,CHAR_RIGHT_PARENTHESES:41,CHAR_ASTERISK:42,CHAR_AMPERSAND:38,CHAR_AT:64,CHAR_BACKWARD_SLASH:92,CHAR_CARRIAGE_RETURN:13,CHAR_CIRCUMFLEX_ACCENT:94,CHAR_COLON:58,CHAR_COMMA:44,CHAR_DOT:46,CHAR_DOUBLE_QUOTE:34,CHAR_EQUAL:61,CHAR_EXCLAMATION_MARK:33,CHAR_FORM_FEED:12,CHAR_FORWARD_SLASH:47,CHAR_GRAVE_ACCENT:96,CHAR_HASH:35,CHAR_HYPHEN_MINUS:45,CHAR_LEFT_ANGLE_BRACKET:60,CHAR_LEFT_CURLY_BRACE:123,CHAR_LEFT_SQUARE_BRACKET:91,CHAR_LINE_FEED:10,CHAR_NO_BREAK_SPACE:160,CHAR_PERCENT:37,CHAR_PLUS:43,CHAR_QUESTION_MARK:63,CHAR_RIGHT_ANGLE_BRACKET:62,CHAR_RIGHT_CURLY_BRACE:125,CHAR_RIGHT_SQUARE_BRACKET:93,CHAR_SEMICOLON:59,CHAR_SINGLE_QUOTE:39,CHAR_SPACE:32,CHAR_TAB:9,CHAR_UNDERSCORE:95,CHAR_VERTICAL_LINE:124,CHAR_ZERO_WIDTH_NOBREAK_SPACE:65279,SEP:cr.sep,extglobChars(s){return{"!":{type:"negate",open:"(?:(?!(?:",close:`))${s.STAR})`},"?":{type:"qmark",open:"(?:",close:")?"},"+":{type:"plus",open:"(?:",close:")+"},"*":{type:"star",open:"(?:",close:")*"},"@":{type:"at",open:"(?:",close:")"}}},globChars(s){return s===!0?vr:Zs}}});var ht=O(re=>{"use strict";var br=require("path"),_r=process.platform==="win32",{REGEX_BACKSLASH:kr,REGEX_REMOVE_BACKSLASH:xr,REGEX_SPECIAL_CHARS:Pr,REGEX_SPECIAL_CHARS_GLOBAL:Cr}=We();re.isObject=s=>s!==null&&typeof s=="object"&&!Array.isArray(s);re.hasRegexChars=s=>Pr.test(s);re.isRegexChar=s=>s.length===1&&re.hasRegexChars(s);re.escapeRegex=s=>s.replace(Cr,"\\$1");re.toPosixSlashes=s=>s.replace(kr,"/");re.removeBackslashes=s=>s.replace(xr,e=>e==="\\"?"":e);re.supportsLookbehinds=()=>{let s=process.version.slice(1).split(".").map(Number);return s.length===3&&s[0]>=9||s[0]===8&&s[1]>=10};re.isWindows=s=>s&&typeof s.windows=="boolean"?s.windows:_r===!0||br.sep==="\\";re.escapeLast=(s,e,t)=>{let n=s.lastIndexOf(e,t);return n===-1?s:s[n-1]==="\\"?re.escapeLast(s,e,n-1):`${s.slice(0,n)}\\${s.slice(n)}`};re.removePrefix=(s,e={})=>{let t=s;return t.startsWith("./")&&(t=t.slice(2),e.prefix="./"),t};re.wrapOutput=(s,e={},t={})=>{let n=t.contains?"":"^",o=t.contains?"":"$",i=`${n}(?:${s})${o}`;return e.negated===!0&&(i=`(?:^(?!${i}).*$)`),i}});var cn=O((Tc,an)=>{"use strict";var en=ht(),{CHAR_ASTERISK:zt,CHAR_AT:Sr,CHAR_BACKWARD_SLASH:qe,CHAR_COMMA:Rr,CHAR_DOT:Vt,CHAR_EXCLAMATION_MARK:Kt,CHAR_FORWARD_SLASH:rn,CHAR_LEFT_CURLY_BRACE:Yt,CHAR_LEFT_PARENTHESES:Qt,CHAR_LEFT_SQUARE_BRACKET:Er,CHAR_PLUS:Ar,CHAR_QUESTION_MARK:tn,CHAR_RIGHT_CURLY_BRACE:Tr,CHAR_RIGHT_PARENTHESES:sn,CHAR_RIGHT_SQUARE_BRACKET:Ir}=We(),nn=s=>s===rn||s===qe,on=s=>{s.isPrefix!==!0&&(s.depth=s.isGlobstar?1/0:1)},$r=(s,e)=>{let t=e||{},n=s.length-1,o=t.parts===!0||t.scanToEnd===!0,i=[],r=[],a=[],c=s,d=-1,p=0,h=0,l=!1,f=!1,v=!1,y=!1,x=!1,A=!1,R=!1,P=!1,F=!1,I=!1,C=0,W,_,T={value:"",depth:0,isGlob:!1},E=()=>d>=n,g=()=>c.charCodeAt(d+1),N=()=>(W=_,c.charCodeAt(++d));for(;d<n;){_=N();let J;if(_===qe){R=T.backslashes=!0,_=N(),_===Yt&&(A=!0);continue}if(A===!0||_===Yt){for(C++;E()!==!0&&(_=N());){if(_===qe){R=T.backslashes=!0,N();continue}if(_===Yt){C++;continue}if(A!==!0&&_===Vt&&(_=N())===Vt){if(l=T.isBrace=!0,v=T.isGlob=!0,I=!0,o===!0)continue;break}if(A!==!0&&_===Rr){if(l=T.isBrace=!0,v=T.isGlob=!0,I=!0,o===!0)continue;break}if(_===Tr&&(C--,C===0)){A=!1,l=T.isBrace=!0,I=!0;break}}if(o===!0)continue;break}if(_===rn){if(i.push(d),r.push(T),T={value:"",depth:0,isGlob:!1},I===!0)continue;if(W===Vt&&d===p+1){p+=2;continue}h=d+1;continue}if(t.noext!==!0&&(_===Ar||_===Sr||_===zt||_===tn||_===Kt)===!0&&g()===Qt){if(v=T.isGlob=!0,y=T.isExtglob=!0,I=!0,_===Kt&&d===p&&(F=!0),o===!0){for(;E()!==!0&&(_=N());){if(_===qe){R=T.backslashes=!0,_=N();continue}if(_===sn){v=T.isGlob=!0,I=!0;break}}continue}break}if(_===zt){if(W===zt&&(x=T.isGlobstar=!0),v=T.isGlob=!0,I=!0,o===!0)continue;break}if(_===tn){if(v=T.isGlob=!0,I=!0,o===!0)continue;break}if(_===Er){for(;E()!==!0&&(J=N());){if(J===qe){R=T.backslashes=!0,N();continue}if(J===Ir){f=T.isBracket=!0,v=T.isGlob=!0,I=!0;break}}if(o===!0)continue;break}if(t.nonegate!==!0&&_===Kt&&d===p){P=T.negated=!0,p++;continue}if(t.noparen!==!0&&_===Qt){if(v=T.isGlob=!0,o===!0){for(;E()!==!0&&(_=N());){if(_===Qt){R=T.backslashes=!0,_=N();continue}if(_===sn){I=!0;break}}continue}break}if(v===!0){if(I=!0,o===!0)continue;break}}t.noext===!0&&(y=!1,v=!1);let $=c,Q="",m="";p>0&&(Q=c.slice(0,p),c=c.slice(p),h-=p),$&&v===!0&&h>0?($=c.slice(0,h),m=c.slice(h)):v===!0?($="",m=c):$=c,$&&$!==""&&$!=="/"&&$!==c&&nn($.charCodeAt($.length-1))&&($=$.slice(0,-1)),t.unescape===!0&&(m&&(m=en.removeBackslashes(m)),$&&R===!0&&($=en.removeBackslashes($)));let w={prefix:Q,input:s,start:p,base:$,glob:m,isBrace:l,isBracket:f,isGlob:v,isExtglob:y,isGlobstar:x,negated:P,negatedExtglob:F};if(t.tokens===!0&&(w.maxDepth=0,nn(_)||r.push(T),w.tokens=r),t.parts===!0||t.tokens===!0){let J;for(let B=0;B<i.length;B++){let ge=J?J+1:p,me=i[B],ie=s.slice(ge,me);t.tokens&&(B===0&&p!==0?(r[B].isPrefix=!0,r[B].value=Q):r[B].value=ie,on(r[B]),w.maxDepth+=r[B].depth),(B!==0||ie!=="")&&a.push(ie),J=me}if(J&&J+1<s.length){let B=s.slice(J+1);a.push(B),t.tokens&&(r[r.length-1].value=B,on(r[r.length-1]),w.maxDepth+=r[r.length-1].depth)}w.slashes=i,w.parts=a}return w};an.exports=$r});var pn=O((Ic,dn)=>{"use strict";var ft=We(),ae=ht(),{MAX_LENGTH:gt,POSIX_REGEX_SOURCE:Mr,REGEX_NON_SPECIAL_CHARS:Dr,REGEX_SPECIAL_CHARS_BACKREF:Fr,REPLACEMENTS:ln}=ft,Lr=(s,e)=>{if(typeof e.expandRange=="function")return e.expandRange(...s,e);s.sort();let t=`[${s.join("-")}]`;try{new RegExp(t)}catch{return s.map(o=>ae.escapeRegex(o)).join("..")}return t},Te=(s,e)=>`Missing ${s}: "${e}" - use "\\\\${e}" to match literal characters`,Xt=(s,e)=>{if(typeof s!="string")throw new TypeError("Expected a string");s=ln[s]||s;let t={...e},n=typeof t.maxLength=="number"?Math.min(gt,t.maxLength):gt,o=s.length;if(o>n)throw new SyntaxError(`Input length: ${o}, exceeds maximum allowed length: ${n}`);let i={type:"bos",value:"",output:t.prepend||""},r=[i],a=t.capture?"":"?:",c=ae.isWindows(e),d=ft.globChars(c),p=ft.extglobChars(d),{DOT_LITERAL:h,PLUS_LITERAL:l,SLASH_LITERAL:f,ONE_CHAR:v,DOTS_SLASH:y,NO_DOT:x,NO_DOT_SLASH:A,NO_DOTS_SLASH:R,QMARK:P,QMARK_NO_DOT:F,STAR:I,START_ANCHOR:C}=d,W=k=>`(${a}(?:(?!${C}${k.dot?y:h}).)*?)`,_=t.dot?"":x,T=t.dot?P:F,E=t.bash===!0?W(t):I;t.capture&&(E=`(${E})`),typeof t.noext=="boolean"&&(t.noextglob=t.noext);let g={input:s,index:-1,start:0,dot:t.dot===!0,consumed:"",output:"",prefix:"",backtrack:!1,negated:!1,brackets:0,braces:0,parens:0,quotes:0,globstar:!1,tokens:r};s=ae.removePrefix(s,g),o=s.length;let N=[],$=[],Q=[],m=i,w,J=()=>g.index===o-1,B=g.peek=(k=1)=>s[g.index+k],ge=g.advance=()=>s[++g.index]||"",me=()=>s.slice(g.index+1),ie=(k="",U=0)=>{g.consumed+=k,g.index+=U},it=k=>{g.output+=k.output!=null?k.output:k.value,ie(k.value)},Zo=()=>{let k=1;for(;B()==="!"&&(B(2)!=="("||B(3)==="?");)ge(),g.start++,k++;return k%2===0?!1:(g.negated=!0,g.start++,!0)},at=k=>{g[k]++,Q.push(k)},ke=k=>{g[k]--,Q.pop()},D=k=>{if(m.type==="globstar"){let U=g.braces>0&&(k.type==="comma"||k.type==="brace"),b=k.extglob===!0||N.length&&(k.type==="pipe"||k.type==="paren");k.type!=="slash"&&k.type!=="paren"&&!U&&!b&&(g.output=g.output.slice(0,-m.output.length),m.type="star",m.value="*",m.output=E,g.output+=m.output)}if(N.length&&k.type!=="paren"&&(N[N.length-1].inner+=k.value),(k.value||k.output)&&it(k),m&&m.type==="text"&&k.type==="text"){m.value+=k.value,m.output=(m.output||"")+k.value;return}k.prev=m,r.push(k),m=k},ct=(k,U)=>{let b={...p[U],conditions:1,inner:""};b.prev=m,b.parens=g.parens,b.output=g.output;let M=(t.capture?"(":"")+b.open;at("parens"),D({type:k,value:U,output:g.output?"":v}),D({type:"paren",extglob:!0,value:ge(),output:M}),N.push(b)},Jo=k=>{let U=k.close+(t.capture?")":""),b;if(k.type==="negate"){let M=E;if(k.inner&&k.inner.length>1&&k.inner.includes("/")&&(M=W(t)),(M!==E||J()||/^\)+$/.test(me()))&&(U=k.close=`)$))${M}`),k.inner.includes("*")&&(b=me())&&/^\.[^\\/.]+$/.test(b)){let z=Xt(b,{...e,fastpaths:!1}).output;U=k.close=`)${z})${M})`}k.prev.type==="bos"&&(g.negatedExtglob=!0)}D({type:"paren",extglob:!0,value:w,output:U}),ke("parens")};if(t.fastpaths!==!1&&!/(^[*!]|[/()[\]{}"])/.test(s)){let k=!1,U=s.replace(Fr,(b,M,z,ne,K,Wt)=>ne==="\\"?(k=!0,b):ne==="?"?M?M+ne+(K?P.repeat(K.length):""):Wt===0?T+(K?P.repeat(K.length):""):P.repeat(z.length):ne==="."?h.repeat(z.length):ne==="*"?M?M+ne+(K?E:""):E:M?b:`\\${b}`);return k===!0&&(t.unescape===!0?U=U.replace(/\\/g,""):U=U.replace(/\\+/g,b=>b.length%2===0?"\\\\":b?"\\":"")),U===s&&t.contains===!0?(g.output=s,g):(g.output=ae.wrapOutput(U,g,e),g)}for(;!J();){if(w=ge(),w==="\0")continue;if(w==="\\"){let b=B();if(b==="/"&&t.bash!==!0||b==="."||b===";")continue;if(!b){w+="\\",D({type:"text",value:w});continue}let M=/^\\+/.exec(me()),z=0;if(M&&M[0].length>2&&(z=M[0].length,g.index+=z,z%2!==0&&(w+="\\")),t.unescape===!0?w=ge():w+=ge(),g.brackets===0){D({type:"text",value:w});continue}}if(g.brackets>0&&(w!=="]"||m.value==="["||m.value==="[^")){if(t.posix!==!1&&w===":"){let b=m.value.slice(1);if(b.includes("[")&&(m.posix=!0,b.includes(":"))){let M=m.value.lastIndexOf("["),z=m.value.slice(0,M),ne=m.value.slice(M+2),K=Mr[ne];if(K){m.value=z+K,g.backtrack=!0,ge(),!i.output&&r.indexOf(m)===1&&(i.output=v);continue}}}(w==="["&&B()!==":"||w==="-"&&B()==="]")&&(w=`\\${w}`),w==="]"&&(m.value==="["||m.value==="[^")&&(w=`\\${w}`),t.posix===!0&&w==="!"&&m.value==="["&&(w="^"),m.value+=w,it({value:w});continue}if(g.quotes===1&&w!=='"'){w=ae.escapeRegex(w),m.value+=w,it({value:w});continue}if(w==='"'){g.quotes=g.quotes===1?0:1,t.keepQuotes===!0&&D({type:"text",value:w});continue}if(w==="("){at("parens"),D({type:"paren",value:w});continue}if(w===")"){if(g.parens===0&&t.strictBrackets===!0)throw new SyntaxError(Te("opening","("));let b=N[N.length-1];if(b&&g.parens===b.parens+1){Jo(N.pop());continue}D({type:"paren",value:w,output:g.parens?")":"\\)"}),ke("parens");continue}if(w==="["){if(t.nobracket===!0||!me().includes("]")){if(t.nobracket!==!0&&t.strictBrackets===!0)throw new SyntaxError(Te("closing","]"));w=`\\${w}`}else at("brackets");D({type:"bracket",value:w});continue}if(w==="]"){if(t.nobracket===!0||m&&m.type==="bracket"&&m.value.length===1){D({type:"text",value:w,output:`\\${w}`});continue}if(g.brackets===0){if(t.strictBrackets===!0)throw new SyntaxError(Te("opening","["));D({type:"text",value:w,output:`\\${w}`});continue}ke("brackets");let b=m.value.slice(1);if(m.posix!==!0&&b[0]==="^"&&!b.includes("/")&&(w=`/${w}`),m.value+=w,it({value:w}),t.literalBrackets===!1||ae.hasRegexChars(b))continue;let M=ae.escapeRegex(m.value);if(g.output=g.output.slice(0,-m.value.length),t.literalBrackets===!0){g.output+=M,m.value=M;continue}m.value=`(${a}${M}|${m.value})`,g.output+=m.value;continue}if(w==="{"&&t.nobrace!==!0){at("braces");let b={type:"brace",value:w,output:"(",outputIndex:g.output.length,tokensIndex:g.tokens.length};$.push(b),D(b);continue}if(w==="}"){let b=$[$.length-1];if(t.nobrace===!0||!b){D({type:"text",value:w,output:w});continue}let M=")";if(b.dots===!0){let z=r.slice(),ne=[];for(let K=z.length-1;K>=0&&(r.pop(),z[K].type!=="brace");K--)z[K].type!=="dots"&&ne.unshift(z[K].value);M=Lr(ne,t),g.backtrack=!0}if(b.comma!==!0&&b.dots!==!0){let z=g.output.slice(0,b.outputIndex),ne=g.tokens.slice(b.tokensIndex);b.value=b.output="\\{",w=M="\\}",g.output=z;for(let K of ne)g.output+=K.output||K.value}D({type:"brace",value:w,output:M}),ke("braces"),$.pop();continue}if(w==="|"){N.length>0&&N[N.length-1].conditions++,D({type:"text",value:w});continue}if(w===","){let b=w,M=$[$.length-1];M&&Q[Q.length-1]==="braces"&&(M.comma=!0,b="|"),D({type:"comma",value:w,output:b});continue}if(w==="/"){if(m.type==="dot"&&g.index===g.start+1){g.start=g.index+1,g.consumed="",g.output="",r.pop(),m=i;continue}D({type:"slash",value:w,output:f});continue}if(w==="."){if(g.braces>0&&m.type==="dot"){m.value==="."&&(m.output=h);let b=$[$.length-1];m.type="dots",m.output+=w,m.value+=w,b.dots=!0;continue}if(g.braces+g.parens===0&&m.type!=="bos"&&m.type!=="slash"){D({type:"text",value:w,output:h});continue}D({type:"dot",value:w,output:h});continue}if(w==="?"){if(!(m&&m.value==="(")&&t.noextglob!==!0&&B()==="("&&B(2)!=="?"){ct("qmark",w);continue}if(m&&m.type==="paren"){let M=B(),z=w;if(M==="<"&&!ae.supportsLookbehinds())throw new Error("Node.js v10 or higher is required for regex lookbehinds");(m.value==="("&&!/[!=<:]/.test(M)||M==="<"&&!/<([!=]|\w+>)/.test(me()))&&(z=`\\${w}`),D({type:"text",value:w,output:z});continue}if(t.dot!==!0&&(m.type==="slash"||m.type==="bos")){D({type:"qmark",value:w,output:F});continue}D({type:"qmark",value:w,output:P});continue}if(w==="!"){if(t.noextglob!==!0&&B()==="("&&(B(2)!=="?"||!/[!=<:]/.test(B(3)))){ct("negate",w);continue}if(t.nonegate!==!0&&g.index===0){Zo();continue}}if(w==="+"){if(t.noextglob!==!0&&B()==="("&&B(2)!=="?"){ct("plus",w);continue}if(m&&m.value==="("||t.regex===!1){D({type:"plus",value:w,output:l});continue}if(m&&(m.type==="bracket"||m.type==="paren"||m.type==="brace")||g.parens>0){D({type:"plus",value:w});continue}D({type:"plus",value:l});continue}if(w==="@"){if(t.noextglob!==!0&&B()==="("&&B(2)!=="?"){D({type:"at",extglob:!0,value:w,output:""});continue}D({type:"text",value:w});continue}if(w!=="*"){(w==="$"||w==="^")&&(w=`\\${w}`);let b=Dr.exec(me());b&&(w+=b[0],g.index+=b[0].length),D({type:"text",value:w});continue}if(m&&(m.type==="globstar"||m.star===!0)){m.type="star",m.star=!0,m.value+=w,m.output=E,g.backtrack=!0,g.globstar=!0,ie(w);continue}let k=me();if(t.noextglob!==!0&&/^\([^?]/.test(k)){ct("star",w);continue}if(m.type==="star"){if(t.noglobstar===!0){ie(w);continue}let b=m.prev,M=b.prev,z=b.type==="slash"||b.type==="bos",ne=M&&(M.type==="star"||M.type==="globstar");if(t.bash===!0&&(!z||k[0]&&k[0]!=="/")){D({type:"star",value:w,output:""});continue}let K=g.braces>0&&(b.type==="comma"||b.type==="brace"),Wt=N.length&&(b.type==="pipe"||b.type==="paren");if(!z&&b.type!=="paren"&&!K&&!Wt){D({type:"star",value:w,output:""});continue}for(;k.slice(0,3)==="/**";){let lt=s[g.index+4];if(lt&&lt!=="/")break;k=k.slice(3),ie("/**",3)}if(b.type==="bos"&&J()){m.type="globstar",m.value+=w,m.output=W(t),g.output=m.output,g.globstar=!0,ie(w);continue}if(b.type==="slash"&&b.prev.type!=="bos"&&!ne&&J()){g.output=g.output.slice(0,-(b.output+m.output).length),b.output=`(?:${b.output}`,m.type="globstar",m.output=W(t)+(t.strictSlashes?")":"|$)"),m.value+=w,g.globstar=!0,g.output+=b.output+m.output,ie(w);continue}if(b.type==="slash"&&b.prev.type!=="bos"&&k[0]==="/"){let lt=k[1]!==void 0?"|$":"";g.output=g.output.slice(0,-(b.output+m.output).length),b.output=`(?:${b.output}`,m.type="globstar",m.output=`${W(t)}${f}|${f}${lt})`,m.value+=w,g.output+=b.output+m.output,g.globstar=!0,ie(w+ge()),D({type:"slash",value:"/",output:""});continue}if(b.type==="bos"&&k[0]==="/"){m.type="globstar",m.value+=w,m.output=`(?:^|${f}|${W(t)}${f})`,g.output=m.output,g.globstar=!0,ie(w+ge()),D({type:"slash",value:"/",output:""});continue}g.output=g.output.slice(0,-m.output.length),m.type="globstar",m.output=W(t),m.value+=w,g.output+=m.output,g.globstar=!0,ie(w);continue}let U={type:"star",value:w,output:E};if(t.bash===!0){U.output=".*?",(m.type==="bos"||m.type==="slash")&&(U.output=_+U.output),D(U);continue}if(m&&(m.type==="bracket"||m.type==="paren")&&t.regex===!0){U.output=w,D(U);continue}(g.index===g.start||m.type==="slash"||m.type==="dot")&&(m.type==="dot"?(g.output+=A,m.output+=A):t.dot===!0?(g.output+=R,m.output+=R):(g.output+=_,m.output+=_),B()!=="*"&&(g.output+=v,m.output+=v)),D(U)}for(;g.brackets>0;){if(t.strictBrackets===!0)throw new SyntaxError(Te("closing","]"));g.output=ae.escapeLast(g.output,"["),ke("brackets")}for(;g.parens>0;){if(t.strictBrackets===!0)throw new SyntaxError(Te("closing",")"));g.output=ae.escapeLast(g.output,"("),ke("parens")}for(;g.braces>0;){if(t.strictBrackets===!0)throw new SyntaxError(Te("closing","}"));g.output=ae.escapeLast(g.output,"{"),ke("braces")}if(t.strictSlashes!==!0&&(m.type==="star"||m.type==="bracket")&&D({type:"maybe_slash",value:"",output:`${f}?`}),g.backtrack===!0){g.output="";for(let k of g.tokens)g.output+=k.output!=null?k.output:k.value,k.suffix&&(g.output+=k.suffix)}return g};Xt.fastpaths=(s,e)=>{let t={...e},n=typeof t.maxLength=="number"?Math.min(gt,t.maxLength):gt,o=s.length;if(o>n)throw new SyntaxError(`Input length: ${o}, exceeds maximum allowed length: ${n}`);s=ln[s]||s;let i=ae.isWindows(e),{DOT_LITERAL:r,SLASH_LITERAL:a,ONE_CHAR:c,DOTS_SLASH:d,NO_DOT:p,NO_DOTS:h,NO_DOTS_SLASH:l,STAR:f,START_ANCHOR:v}=ft.globChars(i),y=t.dot?h:p,x=t.dot?l:p,A=t.capture?"":"?:",R={negated:!1,prefix:""},P=t.bash===!0?".*?":f;t.capture&&(P=`(${P})`);let F=_=>_.noglobstar===!0?P:`(${A}(?:(?!${v}${_.dot?d:r}).)*?)`,I=_=>{switch(_){case"*":return`${y}${c}${P}`;case".*":return`${r}${c}${P}`;case"*.*":return`${y}${P}${r}${c}${P}`;case"*/*":return`${y}${P}${a}${c}${x}${P}`;case"**":return y+F(t);case"**/*":return`(?:${y}${F(t)}${a})?${x}${c}${P}`;case"**/*.*":return`(?:${y}${F(t)}${a})?${x}${P}${r}${c}${P}`;case"**/.*":return`(?:${y}${F(t)}${a})?${r}${c}${P}`;default:{let T=/^(.*?)\.(\w+)$/.exec(_);if(!T)return;let E=I(T[1]);return E?E+r+T[2]:void 0}}},C=ae.removePrefix(s,R),W=I(C);return W&&t.strictSlashes!==!0&&(W+=`${a}?`),W};dn.exports=Xt});var hn=O(($c,un)=>{"use strict";var Hr=require("path"),Nr=cn(),Zt=pn(),Jt=ht(),Br=We(),Or=s=>s&&typeof s=="object"&&!Array.isArray(s),V=(s,e,t=!1)=>{if(Array.isArray(s)){let p=s.map(l=>V(l,e,t));return l=>{for(let f of p){let v=f(l);if(v)return v}return!1}}let n=Or(s)&&s.tokens&&s.input;if(s===""||typeof s!="string"&&!n)throw new TypeError("Expected pattern to be a non-empty string");let o=e||{},i=Jt.isWindows(e),r=n?V.compileRe(s,e):V.makeRe(s,e,!1,!0),a=r.state;delete r.state;let c=()=>!1;if(o.ignore){let p={...e,ignore:null,onMatch:null,onResult:null};c=V(o.ignore,p,t)}let d=(p,h=!1)=>{let{isMatch:l,match:f,output:v}=V.test(p,r,e,{glob:s,posix:i}),y={glob:s,state:a,regex:r,posix:i,input:p,output:v,match:f,isMatch:l};return typeof o.onResult=="function"&&o.onResult(y),l===!1?(y.isMatch=!1,h?y:!1):c(p)?(typeof o.onIgnore=="function"&&o.onIgnore(y),y.isMatch=!1,h?y:!1):(typeof o.onMatch=="function"&&o.onMatch(y),h?y:!0)};return t&&(d.state=a),d};V.test=(s,e,t,{glob:n,posix:o}={})=>{if(typeof s!="string")throw new TypeError("Expected input to be a string");if(s==="")return{isMatch:!1,output:""};let i=t||{},r=i.format||(o?Jt.toPosixSlashes:null),a=s===n,c=a&&r?r(s):s;return a===!1&&(c=r?r(s):s,a=c===n),(a===!1||i.capture===!0)&&(i.matchBase===!0||i.basename===!0?a=V.matchBase(s,e,t,o):a=e.exec(c)),{isMatch:!!a,match:a,output:c}};V.matchBase=(s,e,t,n=Jt.isWindows(t))=>(e instanceof RegExp?e:V.makeRe(e,t)).test(Hr.basename(s));V.isMatch=(s,e,t)=>V(e,t)(s);V.parse=(s,e)=>Array.isArray(s)?s.map(t=>V.parse(t,e)):Zt(s,{...e,fastpaths:!1});V.scan=(s,e)=>Nr(s,e);V.compileRe=(s,e,t=!1,n=!1)=>{if(t===!0)return s.output;let o=e||{},i=o.contains?"":"^",r=o.contains?"":"$",a=`${i}(?:${s.output})${r}`;s&&s.negated===!0&&(a=`^(?!${a}).*$`);let c=V.toRegex(a,e);return n===!0&&(c.state=s),c};V.makeRe=(s,e={},t=!1,n=!1)=>{if(!s||typeof s!="string")throw new TypeError("Expected a non-empty string");let o={negated:!1,fastpaths:!0};return e.fastpaths!==!1&&(s[0]==="."||s[0]==="*")&&(o.output=Zt.fastpaths(s,e)),o.output||(o=Zt(s,e)),V.compileRe(o,e,t,n)};V.toRegex=(s,e)=>{try{let t=e||{};return new RegExp(s,t.flags||(t.nocase?"i":""))}catch(t){if(e&&e.debug===!0)throw t;return/$^/}};V.constants=Br;un.exports=V});var es=O((Mc,fn)=>{"use strict";fn.exports=hn()});var kn=O((Dc,_n)=>{"use strict";var Ge=require("fs"),{Readable:jr}=require("stream"),Ue=require("path"),{promisify:yt}=require("util"),ts=es(),Wr=yt(Ge.readdir),qr=yt(Ge.stat),gn=yt(Ge.lstat),Ur=yt(Ge.realpath),Gr="!",yn="READDIRP_RECURSIVE_ERROR",zr=new Set(["ENOENT","EPERM","EACCES","ELOOP",yn]),ss="files",bn="directories",wt="files_directories",mt="all",mn=[ss,bn,wt,mt],Vr=s=>zr.has(s.code),[wn,Kr]=process.versions.node.split(".").slice(0,2).map(s=>Number.parseInt(s,10)),Yr=process.platform==="win32"&&(wn>10||wn===10&&Kr>=5),vn=s=>{if(s!==void 0){if(typeof s=="function")return s;if(typeof s=="string"){let e=ts(s.trim());return t=>e(t.basename)}if(Array.isArray(s)){let e=[],t=[];for(let n of s){let o=n.trim();o.charAt(0)===Gr?t.push(ts(o.slice(1))):e.push(ts(o))}return t.length>0?e.length>0?n=>e.some(o=>o(n.basename))&&!t.some(o=>o(n.basename)):n=>!t.some(o=>o(n.basename)):n=>e.some(o=>o(n.basename))}}},vt=class s extends jr{static get defaultOptions(){return{root:".",fileFilter:e=>!0,directoryFilter:e=>!0,type:ss,lstat:!1,depth:2147483648,alwaysStat:!1}}constructor(e={}){super({objectMode:!0,autoDestroy:!0,highWaterMark:e.highWaterMark||4096});let t={...s.defaultOptions,...e},{root:n,type:o}=t;this._fileFilter=vn(t.fileFilter),this._directoryFilter=vn(t.directoryFilter);let i=t.lstat?gn:qr;Yr?this._stat=r=>i(r,{bigint:!0}):this._stat=i,this._maxDepth=t.depth,this._wantsDir=[bn,wt,mt].includes(o),this._wantsFile=[ss,wt,mt].includes(o),this._wantsEverything=o===mt,this._root=Ue.resolve(n),this._isDirent="Dirent"in Ge&&!t.alwaysStat,this._statsProp=this._isDirent?"dirent":"stats",this._rdOptions={encoding:"utf8",withFileTypes:this._isDirent},this.parents=[this._exploreDir(n,1)],this.reading=!1,this.parent=void 0}async _read(e){if(!this.reading){this.reading=!0;try{for(;!this.destroyed&&e>0;){let{path:t,depth:n,files:o=[]}=this.parent||{};if(o.length>0){let i=o.splice(0,e).map(r=>this._formatEntry(r,t));for(let r of await Promise.all(i)){if(this.destroyed)return;let a=await this._getEntryType(r);a==="directory"&&this._directoryFilter(r)?(n<=this._maxDepth&&this.parents.push(this._exploreDir(r.fullPath,n+1)),this._wantsDir&&(this.push(r),e--)):(a==="file"||this._includeAsFile(r))&&this._fileFilter(r)&&this._wantsFile&&(this.push(r),e--)}}else{let i=this.parents.pop();if(!i){this.push(null);break}if(this.parent=await i,this.destroyed)return}}}catch(t){this.destroy(t)}finally{this.reading=!1}}}async _exploreDir(e,t){let n;try{n=await Wr(e,this._rdOptions)}catch(o){this._onError(o)}return{files:n,depth:t,path:e}}async _formatEntry(e,t){let n;try{let o=this._isDirent?e.name:e,i=Ue.resolve(Ue.join(t,o));n={path:Ue.relative(this._root,i),fullPath:i,basename:o},n[this._statsProp]=this._isDirent?e:await this._stat(i)}catch(o){this._onError(o)}return n}_onError(e){Vr(e)&&!this.destroyed?this.emit("warn",e):this.destroy(e)}async _getEntryType(e){let t=e&&e[this._statsProp];if(t){if(t.isFile())return"file";if(t.isDirectory())return"directory";if(t&&t.isSymbolicLink()){let n=e.fullPath;try{let o=await Ur(n),i=await gn(o);if(i.isFile())return"file";if(i.isDirectory()){let r=o.length;if(n.startsWith(o)&&n.substr(r,1)===Ue.sep){let a=new Error(`Circular symlink detected: "${n}" points to "${o}"`);return a.code=yn,this._onError(a)}return"directory"}}catch(o){this._onError(o)}}}}_includeAsFile(e){let t=e&&e[this._statsProp];return t&&this._wantsEverything&&!t.isDirectory()}},Ie=(s,e={})=>{let t=e.entryType||e.type;if(t==="both"&&(t=wt),t&&(e.type=t),s){if(typeof s!="string")throw new TypeError("readdirp: root argument must be a string. Usage: readdirp(root, options)");if(t&&!mn.includes(t))throw new Error(`readdirp: Invalid type passed. Use one of ${mn.join(", ")}`)}else throw new Error("readdirp: root argument is required. Usage: readdirp(root, options)");return e.root=s,new vt(e)},Qr=(s,e={})=>new Promise((t,n)=>{let o=[];Ie(s,e).on("data",i=>o.push(i)).on("end",()=>t(o)).on("error",i=>n(i))});Ie.promise=Qr;Ie.ReaddirpStream=vt;Ie.default=Ie;_n.exports=Ie});var ns=O((Fc,xn)=>{xn.exports=function(s,e){if(typeof s!="string")throw new TypeError("expected path to be a string");if(s==="\\"||s==="/")return"/";var t=s.length;if(t<=1)return s;var n="";if(t>4&&s[3]==="\\"){var o=s[2];(o==="?"||o===".")&&s.slice(0,2)==="\\\\"&&(s=s.slice(2),n="//")}var i=s.split(/[/\\]+/);return e!==!1&&i[i.length-1]===""&&i.pop(),n+i.join("/")}});var An=O((Rn,En)=>{"use strict";Object.defineProperty(Rn,"__esModule",{value:!0});var Sn=es(),Xr=ns(),Pn="!",Zr={returnIndex:!1},Jr=s=>Array.isArray(s)?s:[s],ei=(s,e)=>{if(typeof s=="function")return s;if(typeof s=="string"){let t=Sn(s,e);return n=>s===n||t(n)}return s instanceof RegExp?t=>s.test(t):t=>!1},Cn=(s,e,t,n)=>{let o=Array.isArray(t),i=o?t[0]:t;if(!o&&typeof i!="string")throw new TypeError("anymatch: second argument must be a string: got "+Object.prototype.toString.call(i));let r=Xr(i,!1);for(let c=0;c<e.length;c++){let d=e[c];if(d(r))return n?-1:!1}let a=o&&[r].concat(t.slice(1));for(let c=0;c<s.length;c++){let d=s[c];if(o?d(...a):d(r))return n?c:!0}return n?-1:!1},os=(s,e,t=Zr)=>{if(s==null)throw new TypeError("anymatch: specify first argument");let n=typeof t=="boolean"?{returnIndex:t}:t,o=n.returnIndex||!1,i=Jr(s),r=i.filter(c=>typeof c=="string"&&c.charAt(0)===Pn).map(c=>c.slice(1)).map(c=>Sn(c,n)),a=i.filter(c=>typeof c!="string"||typeof c=="string"&&c.charAt(0)!==Pn).map(c=>ei(c,n));return e==null?(c,d=!1)=>Cn(a,r,c,typeof d=="boolean"?d:!1):Cn(a,r,e,o)};os.default=os;En.exports=os});var In=O((Lc,Tn)=>{Tn.exports=function(e){if(typeof e!="string"||e==="")return!1;for(var t;t=/(\\).|([@?!+*]\(.*\))/g.exec(e);){if(t[2])return!0;e=e.slice(t.index+t[0].length)}return!1}});var rs=O((Hc,Mn)=>{var ti=In(),$n={"{":"}","(":")","[":"]"},si=function(s){if(s[0]==="!")return!0;for(var e=0,t=-2,n=-2,o=-2,i=-2,r=-2;e<s.length;){if(s[e]==="*"||s[e+1]==="?"&&/[\].+)]/.test(s[e])||n!==-1&&s[e]==="["&&s[e+1]!=="]"&&(n<e&&(n=s.indexOf("]",e)),n>e&&(r===-1||r>n||(r=s.indexOf("\\",e),r===-1||r>n)))||o!==-1&&s[e]==="{"&&s[e+1]!=="}"&&(o=s.indexOf("}",e),o>e&&(r=s.indexOf("\\",e),r===-1||r>o))||i!==-1&&s[e]==="("&&s[e+1]==="?"&&/[:!=]/.test(s[e+2])&&s[e+3]!==")"&&(i=s.indexOf(")",e),i>e&&(r=s.indexOf("\\",e),r===-1||r>i))||t!==-1&&s[e]==="("&&s[e+1]!=="|"&&(t<e&&(t=s.indexOf("|",e)),t!==-1&&s[t+1]!==")"&&(i=s.indexOf(")",t),i>t&&(r=s.indexOf("\\",t),r===-1||r>i))))return!0;if(s[e]==="\\"){var a=s[e+1];e+=2;var c=$n[a];if(c){var d=s.indexOf(c,e);d!==-1&&(e=d+1)}if(s[e]==="!")return!0}else e++}return!1},ni=function(s){if(s[0]==="!")return!0;for(var e=0;e<s.length;){if(/[*?{}()[\]]/.test(s[e]))return!0;if(s[e]==="\\"){var t=s[e+1];e+=2;var n=$n[t];if(n){var o=s.indexOf(n,e);o!==-1&&(e=o+1)}if(s[e]==="!")return!0}else e++}return!1};Mn.exports=function(e,t){if(typeof e!="string"||e==="")return!1;if(ti(e))return!0;var n=si;return t&&t.strict===!1&&(n=ni),n(e)}});var Fn=O((Nc,Dn)=>{"use strict";var oi=rs(),ri=require("path").posix.dirname,ii=require("os").platform()==="win32",is="/",ai=/\\/g,ci=/[\{\[].*[\}\]]$/,li=/(^|[^\\])([\{\[]|\([^\)]+$)/,di=/\\([\!\*\?\|\[\]\(\)\{\}])/g;Dn.exports=function(e,t){var n=Object.assign({flipBackslashes:!0},t);n.flipBackslashes&&ii&&e.indexOf(is)<0&&(e=e.replace(ai,is)),ci.test(e)&&(e+=is),e+="a";do e=ri(e);while(oi(e)||li.test(e));return e.replace(di,"$1")}});var bt=O(pe=>{"use strict";pe.isInteger=s=>typeof s=="number"?Number.isInteger(s):typeof s=="string"&&s.trim()!==""?Number.isInteger(Number(s)):!1;pe.find=(s,e)=>s.nodes.find(t=>t.type===e);pe.exceedsLimit=(s,e,t=1,n)=>n===!1||!pe.isInteger(s)||!pe.isInteger(e)?!1:(Number(e)-Number(s))/Number(t)>=n;pe.escapeNode=(s,e=0,t)=>{let n=s.nodes[e];n&&(t&&n.type===t||n.type==="open"||n.type==="close")&&n.escaped!==!0&&(n.value="\\"+n.value,n.escaped=!0)};pe.encloseBrace=s=>s.type!=="brace"?!1:s.commas>>0+s.ranges>>0===0?(s.invalid=!0,!0):!1;pe.isInvalidBrace=s=>s.type!=="brace"?!1:s.invalid===!0||s.dollar?!0:s.commas>>0+s.ranges>>0===0||s.open!==!0||s.close!==!0?(s.invalid=!0,!0):!1;pe.isOpenOrClose=s=>s.type==="open"||s.type==="close"?!0:s.open===!0||s.close===!0;pe.reduce=s=>s.reduce((e,t)=>(t.type==="text"&&e.push(t.value),t.type==="range"&&(t.type="text"),e),[]);pe.flatten=(...s)=>{let e=[],t=n=>{for(let o=0;o<n.length;o++){let i=n[o];if(Array.isArray(i)){t(i);continue}i!==void 0&&e.push(i)}return e};return t(s),e}});var _t=O((Oc,Hn)=>{"use strict";var Ln=bt();Hn.exports=(s,e={})=>{let t=(n,o={})=>{let i=e.escapeInvalid&&Ln.isInvalidBrace(o),r=n.invalid===!0&&e.escapeInvalid===!0,a="";if(n.value)return(i||r)&&Ln.isOpenOrClose(n)?"\\"+n.value:n.value;if(n.value)return n.value;if(n.nodes)for(let c of n.nodes)a+=t(c);return a};return t(s)}});var Bn=O((jc,Nn)=>{"use strict";Nn.exports=function(s){return typeof s=="number"?s-s===0:typeof s=="string"&&s.trim()!==""?Number.isFinite?Number.isFinite(+s):isFinite(+s):!1}});var Kn=O((Wc,Vn)=>{"use strict";var On=Bn(),xe=(s,e,t)=>{if(On(s)===!1)throw new TypeError("toRegexRange: expected the first argument to be a number");if(e===void 0||s===e)return String(s);if(On(e)===!1)throw new TypeError("toRegexRange: expected the second argument to be a number.");let n={relaxZeros:!0,...t};typeof n.strictZeros=="boolean"&&(n.relaxZeros=n.strictZeros===!1);let o=String(n.relaxZeros),i=String(n.shorthand),r=String(n.capture),a=String(n.wrap),c=s+":"+e+"="+o+i+r+a;if(xe.cache.hasOwnProperty(c))return xe.cache[c].result;let d=Math.min(s,e),p=Math.max(s,e);if(Math.abs(d-p)===1){let y=s+"|"+e;return n.capture?`(${y})`:n.wrap===!1?y:`(?:${y})`}let h=zn(s)||zn(e),l={min:s,max:e,a:d,b:p},f=[],v=[];if(h&&(l.isPadded=h,l.maxLen=String(l.max).length),d<0){let y=p<0?Math.abs(p):1;v=jn(y,Math.abs(d),l,n),d=l.a=0}return p>=0&&(f=jn(d,p,l,n)),l.negatives=v,l.positives=f,l.result=pi(v,f,n),n.capture===!0?l.result=`(${l.result})`:n.wrap!==!1&&f.length+v.length>1&&(l.result=`(?:${l.result})`),xe.cache[c]=l,l.result};function pi(s,e,t){let n=as(s,e,"-",!1,t)||[],o=as(e,s,"",!1,t)||[],i=as(s,e,"-?",!0,t)||[];return n.concat(i).concat(o).join("|")}function ui(s,e){let t=1,n=1,o=qn(s,t),i=new Set([e]);for(;s<=o&&o<=e;)i.add(o),t+=1,o=qn(s,t);for(o=Un(e+1,n)-1;s<o&&o<=e;)i.add(o),n+=1,o=Un(e+1,n)-1;return i=[...i],i.sort(gi),i}function hi(s,e,t){if(s===e)return{pattern:s,count:[],digits:0};let n=fi(s,e),o=n.length,i="",r=0;for(let a=0;a<o;a++){let[c,d]=n[a];c===d?i+=c:c!=="0"||d!=="9"?i+=mi(c,d,t):r++}return r&&(i+=t.shorthand===!0?"\\d":"[0-9]"),{pattern:i,count:[r],digits:o}}function jn(s,e,t,n){let o=ui(s,e),i=[],r=s,a;for(let c=0;c<o.length;c++){let d=o[c],p=hi(String(r),String(d),n),h="";if(!t.isPadded&&a&&a.pattern===p.pattern){a.count.length>1&&a.count.pop(),a.count.push(p.count[0]),a.string=a.pattern+Gn(a.count),r=d+1;continue}t.isPadded&&(h=wi(d,t,n)),p.string=h+p.pattern+Gn(p.count),i.push(p),r=d+1,a=p}return i}function as(s,e,t,n,o){let i=[];for(let r of s){let{string:a}=r;!n&&!Wn(e,"string",a)&&i.push(t+a),n&&Wn(e,"string",a)&&i.push(t+a)}return i}function fi(s,e){let t=[];for(let n=0;n<s.length;n++)t.push([s[n],e[n]]);return t}function gi(s,e){return s>e?1:e>s?-1:0}function Wn(s,e,t){return s.some(n=>n[e]===t)}function qn(s,e){return Number(String(s).slice(0,-e)+"9".repeat(e))}function Un(s,e){return s-s%Math.pow(10,e)}function Gn(s){let[e=0,t=""]=s;return t||e>1?`{${e+(t?","+t:"")}}`:""}function mi(s,e,t){return`[${s}${e-s===1?"":"-"}${e}]`}function zn(s){return/^-?(0+)\d/.test(s)}function wi(s,e,t){if(!e.isPadded)return s;let n=Math.abs(e.maxLen-String(s).length),o=t.relaxZeros!==!1;switch(n){case 0:return"";case 1:return o?"0?":"0";case 2:return o?"0{0,2}":"00";default:return o?`0{0,${n}}`:`0{${n}}`}}xe.cache={};xe.clearCache=()=>xe.cache={};Vn.exports=xe});var ds=O((qc,to)=>{"use strict";var vi=require("util"),Qn=Kn(),Yn=s=>s!==null&&typeof s=="object"&&!Array.isArray(s),yi=s=>e=>s===!0?Number(e):String(e),cs=s=>typeof s=="number"||typeof s=="string"&&s!=="",ze=s=>Number.isInteger(+s),ls=s=>{let e=`${s}`,t=-1;if(e[0]==="-"&&(e=e.slice(1)),e==="0")return!1;for(;e[++t]==="0";);return t>0},bi=(s,e,t)=>typeof s=="string"||typeof e=="string"?!0:t.stringify===!0,_i=(s,e,t)=>{if(e>0){let n=s[0]==="-"?"-":"";n&&(s=s.slice(1)),s=n+s.padStart(n?e-1:e,"0")}return t===!1?String(s):s},xt=(s,e)=>{let t=s[0]==="-"?"-":"";for(t&&(s=s.slice(1),e--);s.length<e;)s="0"+s;return t?"-"+s:s},ki=(s,e,t)=>{s.negatives.sort((a,c)=>a<c?-1:a>c?1:0),s.positives.sort((a,c)=>a<c?-1:a>c?1:0);let n=e.capture?"":"?:",o="",i="",r;return s.positives.length&&(o=s.positives.map(a=>xt(String(a),t)).join("|")),s.negatives.length&&(i=`-(${n}${s.negatives.map(a=>xt(String(a),t)).join("|")})`),o&&i?r=`${o}|${i}`:r=o||i,e.wrap?`(${n}${r})`:r},Xn=(s,e,t,n)=>{if(t)return Qn(s,e,{wrap:!1,...n});let o=String.fromCharCode(s);if(s===e)return o;let i=String.fromCharCode(e);return`[${o}-${i}]`},Zn=(s,e,t)=>{if(Array.isArray(s)){let n=t.wrap===!0,o=t.capture?"":"?:";return n?`(${o}${s.join("|")})`:s.join("|")}return Qn(s,e,t)},Jn=(...s)=>new RangeError("Invalid range arguments: "+vi.inspect(...s)),eo=(s,e,t)=>{if(t.strictRanges===!0)throw Jn([s,e]);return[]},xi=(s,e)=>{if(e.strictRanges===!0)throw new TypeError(`Expected step "${s}" to be a number`);return[]},Pi=(s,e,t=1,n={})=>{let o=Number(s),i=Number(e);if(!Number.isInteger(o)||!Number.isInteger(i)){if(n.strictRanges===!0)throw Jn([s,e]);return[]}o===0&&(o=0),i===0&&(i=0);let r=o>i,a=String(s),c=String(e),d=String(t);t=Math.max(Math.abs(t),1);let p=ls(a)||ls(c)||ls(d),h=p?Math.max(a.length,c.length,d.length):0,l=p===!1&&bi(s,e,n)===!1,f=n.transform||yi(l);if(n.toRegex&&t===1)return Xn(xt(s,h),xt(e,h),!0,n);let v={negatives:[],positives:[]},y=R=>v[R<0?"negatives":"positives"].push(Math.abs(R)),x=[],A=0;for(;r?o>=i:o<=i;)n.toRegex===!0&&t>1?y(o):x.push(_i(f(o,A),h,l)),o=r?o-t:o+t,A++;return n.toRegex===!0?t>1?ki(v,n,h):Zn(x,null,{wrap:!1,...n}):x},Ci=(s,e,t=1,n={})=>{if(!ze(s)&&s.length>1||!ze(e)&&e.length>1)return eo(s,e,n);let o=n.transform||(l=>String.fromCharCode(l)),i=`${s}`.charCodeAt(0),r=`${e}`.charCodeAt(0),a=i>r,c=Math.min(i,r),d=Math.max(i,r);if(n.toRegex&&t===1)return Xn(c,d,!1,n);let p=[],h=0;for(;a?i>=r:i<=r;)p.push(o(i,h)),i=a?i-t:i+t,h++;return n.toRegex===!0?Zn(p,null,{wrap:!1,options:n}):p},kt=(s,e,t,n={})=>{if(e==null&&cs(s))return[s];if(!cs(s)||!cs(e))return eo(s,e,n);if(typeof t=="function")return kt(s,e,1,{transform:t});if(Yn(t))return kt(s,e,0,t);let o={...n};return o.capture===!0&&(o.wrap=!0),t=t||o.step||1,ze(t)?ze(s)&&ze(e)?Pi(s,e,t,o):Ci(s,e,Math.max(Math.abs(t),1),o):t!=null&&!Yn(t)?xi(t,o):kt(s,e,1,t)};to.exports=kt});var oo=O((Uc,no)=>{"use strict";var Si=ds(),so=bt(),Ri=(s,e={})=>{let t=(n,o={})=>{let i=so.isInvalidBrace(o),r=n.invalid===!0&&e.escapeInvalid===!0,a=i===!0||r===!0,c=e.escapeInvalid===!0?"\\":"",d="";if(n.isOpen===!0)return c+n.value;if(n.isClose===!0)return console.log("node.isClose",c,n.value),c+n.value;if(n.type==="open")return a?c+n.value:"(";if(n.type==="close")return a?c+n.value:")";if(n.type==="comma")return n.prev.type==="comma"?"":a?n.value:"|";if(n.value)return n.value;if(n.nodes&&n.ranges>0){let p=so.reduce(n.nodes),h=Si(...p,{...e,wrap:!1,toRegex:!0,strictZeros:!0});if(h.length!==0)return p.length>1&&h.length>1?`(${h})`:h}if(n.nodes)for(let p of n.nodes)d+=t(p,n);return d};return t(s)};no.exports=Ri});var ao=O((Gc,io)=>{"use strict";var Ei=ds(),ro=_t(),$e=bt(),Pe=(s="",e="",t=!1)=>{let n=[];if(s=[].concat(s),e=[].concat(e),!e.length)return s;if(!s.length)return t?$e.flatten(e).map(o=>`{${o}}`):e;for(let o of s)if(Array.isArray(o))for(let i of o)n.push(Pe(i,e,t));else for(let i of e)t===!0&&typeof i=="string"&&(i=`{${i}}`),n.push(Array.isArray(i)?Pe(o,i,t):o+i);return $e.flatten(n)},Ai=(s,e={})=>{let t=e.rangeLimit===void 0?1e3:e.rangeLimit,n=(o,i={})=>{o.queue=[];let r=i,a=i.queue;for(;r.type!=="brace"&&r.type!=="root"&&r.parent;)r=r.parent,a=r.queue;if(o.invalid||o.dollar){a.push(Pe(a.pop(),ro(o,e)));return}if(o.type==="brace"&&o.invalid!==!0&&o.nodes.length===2){a.push(Pe(a.pop(),["{}"]));return}if(o.nodes&&o.ranges>0){let h=$e.reduce(o.nodes);if($e.exceedsLimit(...h,e.step,t))throw new RangeError("expanded array length exceeds range limit. Use options.rangeLimit to increase or disable the limit.");let l=Ei(...h,e);l.length===0&&(l=ro(o,e)),a.push(Pe(a.pop(),l)),o.nodes=[];return}let c=$e.encloseBrace(o),d=o.queue,p=o;for(;p.type!=="brace"&&p.type!=="root"&&p.parent;)p=p.parent,d=p.queue;for(let h=0;h<o.nodes.length;h++){let l=o.nodes[h];if(l.type==="comma"&&o.type==="brace"){h===1&&d.push(""),d.push("");continue}if(l.type==="close"){a.push(Pe(a.pop(),d,c));continue}if(l.value&&l.type!=="open"){d.push(Pe(d.pop(),l.value));continue}l.nodes&&n(l,o)}return d};return $e.flatten(n(s))};io.exports=Ai});var lo=O((zc,co)=>{"use strict";co.exports={MAX_LENGTH:1e4,CHAR_0:"0",CHAR_9:"9",CHAR_UPPERCASE_A:"A",CHAR_LOWERCASE_A:"a",CHAR_UPPERCASE_Z:"Z",CHAR_LOWERCASE_Z:"z",CHAR_LEFT_PARENTHESES:"(",CHAR_RIGHT_PARENTHESES:")",CHAR_ASTERISK:"*",CHAR_AMPERSAND:"&",CHAR_AT:"@",CHAR_BACKSLASH:"\\",CHAR_BACKTICK:"`",CHAR_CARRIAGE_RETURN:"\r",CHAR_CIRCUMFLEX_ACCENT:"^",CHAR_COLON:":",CHAR_COMMA:",",CHAR_DOLLAR:"$",CHAR_DOT:".",CHAR_DOUBLE_QUOTE:'"',CHAR_EQUAL:"=",CHAR_EXCLAMATION_MARK:"!",CHAR_FORM_FEED:"\f",CHAR_FORWARD_SLASH:"/",CHAR_HASH:"#",CHAR_HYPHEN_MINUS:"-",CHAR_LEFT_ANGLE_BRACKET:"<",CHAR_LEFT_CURLY_BRACE:"{",CHAR_LEFT_SQUARE_BRACKET:"[",CHAR_LINE_FEED:`
`,CHAR_NO_BREAK_SPACE:"\xA0",CHAR_PERCENT:"%",CHAR_PLUS:"+",CHAR_QUESTION_MARK:"?",CHAR_RIGHT_ANGLE_BRACKET:">",CHAR_RIGHT_CURLY_BRACE:"}",CHAR_RIGHT_SQUARE_BRACKET:"]",CHAR_SEMICOLON:";",CHAR_SINGLE_QUOTE:"'",CHAR_SPACE:" ",CHAR_TAB:"	",CHAR_UNDERSCORE:"_",CHAR_VERTICAL_LINE:"|",CHAR_ZERO_WIDTH_NOBREAK_SPACE:"\uFEFF"}});var go=O((Vc,fo)=>{"use strict";var Ti=_t(),{MAX_LENGTH:po,CHAR_BACKSLASH:ps,CHAR_BACKTICK:Ii,CHAR_COMMA:$i,CHAR_DOT:Mi,CHAR_LEFT_PARENTHESES:Di,CHAR_RIGHT_PARENTHESES:Fi,CHAR_LEFT_CURLY_BRACE:Li,CHAR_RIGHT_CURLY_BRACE:Hi,CHAR_LEFT_SQUARE_BRACKET:uo,CHAR_RIGHT_SQUARE_BRACKET:ho,CHAR_DOUBLE_QUOTE:Ni,CHAR_SINGLE_QUOTE:Bi,CHAR_NO_BREAK_SPACE:Oi,CHAR_ZERO_WIDTH_NOBREAK_SPACE:ji}=lo(),Wi=(s,e={})=>{if(typeof s!="string")throw new TypeError("Expected a string");let t=e||{},n=typeof t.maxLength=="number"?Math.min(po,t.maxLength):po;if(s.length>n)throw new SyntaxError(`Input length (${s.length}), exceeds max characters (${n})`);let o={type:"root",input:s,nodes:[]},i=[o],r=o,a=o,c=0,d=s.length,p=0,h=0,l,f=()=>s[p++],v=y=>{if(y.type==="text"&&a.type==="dot"&&(a.type="text"),a&&a.type==="text"&&y.type==="text"){a.value+=y.value;return}return r.nodes.push(y),y.parent=r,y.prev=a,a=y,y};for(v({type:"bos"});p<d;)if(r=i[i.length-1],l=f(),!(l===ji||l===Oi)){if(l===ps){v({type:"text",value:(e.keepEscaping?l:"")+f()});continue}if(l===ho){v({type:"text",value:"\\"+l});continue}if(l===uo){c++;let y;for(;p<d&&(y=f());){if(l+=y,y===uo){c++;continue}if(y===ps){l+=f();continue}if(y===ho&&(c--,c===0))break}v({type:"text",value:l});continue}if(l===Di){r=v({type:"paren",nodes:[]}),i.push(r),v({type:"text",value:l});continue}if(l===Fi){if(r.type!=="paren"){v({type:"text",value:l});continue}r=i.pop(),v({type:"text",value:l}),r=i[i.length-1];continue}if(l===Ni||l===Bi||l===Ii){let y=l,x;for(e.keepQuotes!==!0&&(l="");p<d&&(x=f());){if(x===ps){l+=x+f();continue}if(x===y){e.keepQuotes===!0&&(l+=x);break}l+=x}v({type:"text",value:l});continue}if(l===Li){h++;let x={type:"brace",open:!0,close:!1,dollar:a.value&&a.value.slice(-1)==="$"||r.dollar===!0,depth:h,commas:0,ranges:0,nodes:[]};r=v(x),i.push(r),v({type:"open",value:l});continue}if(l===Hi){if(r.type!=="brace"){v({type:"text",value:l});continue}let y="close";r=i.pop(),r.close=!0,v({type:y,value:l}),h--,r=i[i.length-1];continue}if(l===$i&&h>0){if(r.ranges>0){r.ranges=0;let y=r.nodes.shift();r.nodes=[y,{type:"text",value:Ti(r)}]}v({type:"comma",value:l}),r.commas++;continue}if(l===Mi&&h>0&&r.commas===0){let y=r.nodes;if(h===0||y.length===0){v({type:"text",value:l});continue}if(a.type==="dot"){if(r.range=[],a.value+=l,a.type="range",r.nodes.length!==3&&r.nodes.length!==5){r.invalid=!0,r.ranges=0,a.type="text";continue}r.ranges++,r.args=[];continue}if(a.type==="range"){y.pop();let x=y[y.length-1];x.value+=a.value+l,a=x,r.ranges--;continue}v({type:"dot",value:l});continue}v({type:"text",value:l})}do if(r=i.pop(),r.type!=="root"){r.nodes.forEach(A=>{A.nodes||(A.type==="open"&&(A.isOpen=!0),A.type==="close"&&(A.isClose=!0),A.nodes||(A.type="text"),A.invalid=!0)});let y=i[i.length-1],x=y.nodes.indexOf(r);y.nodes.splice(x,1,...r.nodes)}while(i.length>0);return v({type:"eos"}),o};fo.exports=Wi});var vo=O((Kc,wo)=>{"use strict";var mo=_t(),qi=oo(),Ui=ao(),Gi=go(),ce=(s,e={})=>{let t=[];if(Array.isArray(s))for(let n of s){let o=ce.create(n,e);Array.isArray(o)?t.push(...o):t.push(o)}else t=[].concat(ce.create(s,e));return e&&e.expand===!0&&e.nodupes===!0&&(t=[...new Set(t)]),t};ce.parse=(s,e={})=>Gi(s,e);ce.stringify=(s,e={})=>mo(typeof s=="string"?ce.parse(s,e):s,e);ce.compile=(s,e={})=>(typeof s=="string"&&(s=ce.parse(s,e)),qi(s,e));ce.expand=(s,e={})=>{typeof s=="string"&&(s=ce.parse(s,e));let t=Ui(s,e);return e.noempty===!0&&(t=t.filter(Boolean)),e.nodupes===!0&&(t=[...new Set(t)]),t};ce.create=(s,e={})=>s===""||s.length<3?[s]:e.expand!==!0?ce.compile(s,e):ce.expand(s,e);wo.exports=ce});var yo=O((Yc,zi)=>{zi.exports=["3dm","3ds","3g2","3gp","7z","a","aac","adp","afdesign","afphoto","afpub","ai","aif","aiff","alz","ape","apk","appimage","ar","arj","asf","au","avi","bak","baml","bh","bin","bk","bmp","btif","bz2","bzip2","cab","caf","cgm","class","cmx","cpio","cr2","cur","dat","dcm","deb","dex","djvu","dll","dmg","dng","doc","docm","docx","dot","dotm","dra","DS_Store","dsk","dts","dtshd","dvb","dwg","dxf","ecelp4800","ecelp7470","ecelp9600","egg","eol","eot","epub","exe","f4v","fbs","fh","fla","flac","flatpak","fli","flv","fpx","fst","fvt","g3","gh","gif","graffle","gz","gzip","h261","h263","h264","icns","ico","ief","img","ipa","iso","jar","jpeg","jpg","jpgv","jpm","jxr","key","ktx","lha","lib","lvp","lz","lzh","lzma","lzo","m3u","m4a","m4v","mar","mdi","mht","mid","midi","mj2","mka","mkv","mmr","mng","mobi","mov","movie","mp3","mp4","mp4a","mpeg","mpg","mpga","mxu","nef","npx","numbers","nupkg","o","odp","ods","odt","oga","ogg","ogv","otf","ott","pages","pbm","pcx","pdb","pdf","pea","pgm","pic","png","pnm","pot","potm","potx","ppa","ppam","ppm","pps","ppsm","ppsx","ppt","pptm","pptx","psd","pya","pyc","pyo","pyv","qt","rar","ras","raw","resources","rgb","rip","rlc","rmf","rmvb","rpm","rtf","rz","s3m","s7z","scpt","sgi","shar","snap","sil","sketch","slk","smv","snk","so","stl","suo","sub","swf","tar","tbz","tbz2","tga","tgz","thmx","tif","tiff","tlz","ttc","ttf","txz","udf","uvh","uvi","uvm","uvp","uvs","uvu","viv","vob","war","wav","wax","wbmp","wdp","weba","webm","webp","whl","wim","wm","wma","wmv","wmx","woff","woff2","wrm","wvx","xbm","xif","xla","xlam","xls","xlsb","xlsm","xlsx","xlt","xltm","xltx","xm","xmind","xpi","xpm","xwd","xz","z","zip","zipx"]});var _o=O((Qc,bo)=>{bo.exports=yo()});var xo=O((Xc,ko)=>{"use strict";var Vi=require("path"),Ki=_o(),Yi=new Set(Ki);ko.exports=s=>Yi.has(Vi.extname(s).slice(1).toLowerCase())});var Pt=O(S=>{"use strict";var{sep:Qi}=require("path"),{platform:us}=process,Xi=require("os");S.EV_ALL="all";S.EV_READY="ready";S.EV_ADD="add";S.EV_CHANGE="change";S.EV_ADD_DIR="addDir";S.EV_UNLINK="unlink";S.EV_UNLINK_DIR="unlinkDir";S.EV_RAW="raw";S.EV_ERROR="error";S.STR_DATA="data";S.STR_END="end";S.STR_CLOSE="close";S.FSEVENT_CREATED="created";S.FSEVENT_MODIFIED="modified";S.FSEVENT_DELETED="deleted";S.FSEVENT_MOVED="moved";S.FSEVENT_CLONED="cloned";S.FSEVENT_UNKNOWN="unknown";S.FSEVENT_FLAG_MUST_SCAN_SUBDIRS=1;S.FSEVENT_TYPE_FILE="file";S.FSEVENT_TYPE_DIRECTORY="directory";S.FSEVENT_TYPE_SYMLINK="symlink";S.KEY_LISTENERS="listeners";S.KEY_ERR="errHandlers";S.KEY_RAW="rawEmitters";S.HANDLER_KEYS=[S.KEY_LISTENERS,S.KEY_ERR,S.KEY_RAW];S.DOT_SLASH=`.${Qi}`;S.BACK_SLASH_RE=/\\/g;S.DOUBLE_SLASH_RE=/\/\//;S.SLASH_OR_BACK_SLASH_RE=/[/\\]/;S.DOT_RE=/\..*\.(sw[px])$|~$|\.subl.*\.tmp/;S.REPLACER_RE=/^\.[/\\]/;S.SLASH="/";S.SLASH_SLASH="//";S.BRACE_START="{";S.BANG="!";S.ONE_DOT=".";S.TWO_DOTS="..";S.STAR="*";S.GLOBSTAR="**";S.ROOT_GLOBSTAR="/**/*";S.SLASH_GLOBSTAR="/**";S.DIR_SUFFIX="Dir";S.ANYMATCH_OPTS={dot:!0};S.STRING_TYPE="string";S.FUNCTION_TYPE="function";S.EMPTY_STR="";S.EMPTY_FN=()=>{};S.IDENTITY_FN=s=>s;S.isWindows=us==="win32";S.isMacos=us==="darwin";S.isLinux=us==="linux";S.isIBMi=Xi.type()==="OS400"});var Ao=O((Jc,Eo)=>{"use strict";var _e=require("fs"),X=require("path"),{promisify:Qe}=require("util"),Zi=xo(),{isWindows:Ji,isLinux:ea,EMPTY_FN:ta,EMPTY_STR:sa,KEY_LISTENERS:Me,KEY_ERR:hs,KEY_RAW:Ve,HANDLER_KEYS:na,EV_CHANGE:St,EV_ADD:Ct,EV_ADD_DIR:oa,EV_ERROR:Co,STR_DATA:ra,STR_END:ia,BRACE_START:aa,STAR:ca}=Pt(),la="watch",da=Qe(_e.open),So=Qe(_e.stat),pa=Qe(_e.lstat),ua=Qe(_e.close),fs=Qe(_e.realpath),ha={lstat:pa,stat:So},ms=(s,e)=>{s instanceof Set?s.forEach(e):e(s)},Ke=(s,e,t)=>{let n=s[e];n instanceof Set||(s[e]=n=new Set([n])),n.add(t)},fa=s=>e=>{let t=s[e];t instanceof Set?t.clear():delete s[e]},Ye=(s,e,t)=>{let n=s[e];n instanceof Set?n.delete(t):n===t&&delete s[e]},Ro=s=>s instanceof Set?s.size===0:!s,Rt=new Map;function Po(s,e,t,n,o){let i=(r,a)=>{t(s),o(r,a,{watchedPath:s}),a&&s!==a&&Et(X.resolve(s,a),Me,X.join(s,a))};try{return _e.watch(s,e,i)}catch(r){n(r)}}var Et=(s,e,t,n,o)=>{let i=Rt.get(s);i&&ms(i[e],r=>{r(t,n,o)})},ga=(s,e,t,n)=>{let{listener:o,errHandler:i,rawEmitter:r}=n,a=Rt.get(e),c;if(!t.persistent)return c=Po(s,t,o,i,r),c.close.bind(c);if(a)Ke(a,Me,o),Ke(a,hs,i),Ke(a,Ve,r);else{if(c=Po(s,t,Et.bind(null,e,Me),i,Et.bind(null,e,Ve)),!c)return;c.on(Co,async d=>{let p=Et.bind(null,e,hs);if(a.watcherUnusable=!0,Ji&&d.code==="EPERM")try{let h=await da(s,"r");await ua(h),p(d)}catch{}else p(d)}),a={listeners:o,errHandlers:i,rawEmitters:r,watcher:c},Rt.set(e,a)}return()=>{Ye(a,Me,o),Ye(a,hs,i),Ye(a,Ve,r),Ro(a.listeners)&&(a.watcher.close(),Rt.delete(e),na.forEach(fa(a)),a.watcher=void 0,Object.freeze(a))}},gs=new Map,ma=(s,e,t,n)=>{let{listener:o,rawEmitter:i}=n,r=gs.get(e),a=new Set,c=new Set,d=r&&r.options;return d&&(d.persistent<t.persistent||d.interval>t.interval)&&(a=r.listeners,c=r.rawEmitters,_e.unwatchFile(e),r=void 0),r?(Ke(r,Me,o),Ke(r,Ve,i)):(r={listeners:o,rawEmitters:i,options:t,watcher:_e.watchFile(e,t,(p,h)=>{ms(r.rawEmitters,f=>{f(St,e,{curr:p,prev:h})});let l=p.mtimeMs;(p.size!==h.size||l>h.mtimeMs||l===0)&&ms(r.listeners,f=>f(s,p))})},gs.set(e,r)),()=>{Ye(r,Me,o),Ye(r,Ve,i),Ro(r.listeners)&&(gs.delete(e),_e.unwatchFile(e),r.options=r.watcher=void 0,Object.freeze(r))}},ws=class{constructor(e){this.fsw=e,this._boundHandleError=t=>e._handleError(t)}_watchWithNodeFs(e,t){let n=this.fsw.options,o=X.dirname(e),i=X.basename(e);this.fsw._getWatchedDir(o).add(i);let a=X.resolve(e),c={persistent:n.persistent};t||(t=ta);let d;return n.usePolling?(c.interval=n.enableBinaryInterval&&Zi(i)?n.binaryInterval:n.interval,d=ma(e,a,c,{listener:t,rawEmitter:this.fsw._emitRaw})):d=ga(e,a,c,{listener:t,errHandler:this._boundHandleError,rawEmitter:this.fsw._emitRaw}),d}_handleFile(e,t,n){if(this.fsw.closed)return;let o=X.dirname(e),i=X.basename(e),r=this.fsw._getWatchedDir(o),a=t;if(r.has(i))return;let c=async(p,h)=>{if(this.fsw._throttle(la,e,5)){if(!h||h.mtimeMs===0)try{let l=await So(e);if(this.fsw.closed)return;let f=l.atimeMs,v=l.mtimeMs;(!f||f<=v||v!==a.mtimeMs)&&this.fsw._emit(St,e,l),ea&&a.ino!==l.ino?(this.fsw._closeFile(p),a=l,this.fsw._addPathCloser(p,this._watchWithNodeFs(e,c))):a=l}catch{this.fsw._remove(o,i)}else if(r.has(i)){let l=h.atimeMs,f=h.mtimeMs;(!l||l<=f||f!==a.mtimeMs)&&this.fsw._emit(St,e,h),a=h}}},d=this._watchWithNodeFs(e,c);if(!(n&&this.fsw.options.ignoreInitial)&&this.fsw._isntIgnored(e)){if(!this.fsw._throttle(Ct,e,0))return;this.fsw._emit(Ct,e,t)}return d}async _handleSymlink(e,t,n,o){if(this.fsw.closed)return;let i=e.fullPath,r=this.fsw._getWatchedDir(t);if(!this.fsw.options.followSymlinks){this.fsw._incrReadyCount();let a;try{a=await fs(n)}catch{return this.fsw._emitReady(),!0}return this.fsw.closed?void 0:(r.has(o)?this.fsw._symlinkPaths.get(i)!==a&&(this.fsw._symlinkPaths.set(i,a),this.fsw._emit(St,n,e.stats)):(r.add(o),this.fsw._symlinkPaths.set(i,a),this.fsw._emit(Ct,n,e.stats)),this.fsw._emitReady(),!0)}if(this.fsw._symlinkPaths.has(i))return!0;this.fsw._symlinkPaths.set(i,!0)}_handleRead(e,t,n,o,i,r,a){if(e=X.join(e,sa),!n.hasGlob&&(a=this.fsw._throttle("readdir",e,1e3),!a))return;let c=this.fsw._getWatchedDir(n.path),d=new Set,p=this.fsw._readdirp(e,{fileFilter:h=>n.filterPath(h),directoryFilter:h=>n.filterDir(h),depth:0}).on(ra,async h=>{if(this.fsw.closed){p=void 0;return}let l=h.path,f=X.join(e,l);if(d.add(l),!(h.stats.isSymbolicLink()&&await this._handleSymlink(h,e,f,l))){if(this.fsw.closed){p=void 0;return}(l===o||!o&&!c.has(l))&&(this.fsw._incrReadyCount(),f=X.join(i,X.relative(i,f)),this._addToNodeFs(f,t,n,r+1))}}).on(Co,this._boundHandleError);return new Promise(h=>p.once(ia,()=>{if(this.fsw.closed){p=void 0;return}let l=a?a.clear():!1;h(),c.getChildren().filter(f=>f!==e&&!d.has(f)&&(!n.hasGlob||n.filterPath({fullPath:X.resolve(e,f)}))).forEach(f=>{this.fsw._remove(e,f)}),p=void 0,l&&this._handleRead(e,!1,n,o,i,r,a)}))}async _handleDir(e,t,n,o,i,r,a){let c=this.fsw._getWatchedDir(X.dirname(e)),d=c.has(X.basename(e));!(n&&this.fsw.options.ignoreInitial)&&!i&&!d&&(!r.hasGlob||r.globFilter(e))&&this.fsw._emit(oa,e,t),c.add(X.basename(e)),this.fsw._getWatchedDir(e);let p,h,l=this.fsw.options.depth;if((l==null||o<=l)&&!this.fsw._symlinkPaths.has(a)){if(!i&&(await this._handleRead(e,n,r,i,e,o,p),this.fsw.closed))return;h=this._watchWithNodeFs(e,(f,v)=>{v&&v.mtimeMs===0||this._handleRead(f,!1,r,i,e,o,p)})}return h}async _addToNodeFs(e,t,n,o,i){let r=this.fsw._emitReady;if(this.fsw._isIgnored(e)||this.fsw.closed)return r(),!1;let a=this.fsw._getWatchHelpers(e,o);!a.hasGlob&&n&&(a.hasGlob=n.hasGlob,a.globFilter=n.globFilter,a.filterPath=c=>n.filterPath(c),a.filterDir=c=>n.filterDir(c));try{let c=await ha[a.statMethod](a.watchPath);if(this.fsw.closed)return;if(this.fsw._isIgnored(a.watchPath,c))return r(),!1;let d=this.fsw.options.followSymlinks&&!e.includes(ca)&&!e.includes(aa),p;if(c.isDirectory()){let h=X.resolve(e),l=d?await fs(e):e;if(this.fsw.closed||(p=await this._handleDir(a.watchPath,c,t,o,i,a,l),this.fsw.closed))return;h!==l&&l!==void 0&&this.fsw._symlinkPaths.set(h,l)}else if(c.isSymbolicLink()){let h=d?await fs(e):e;if(this.fsw.closed)return;let l=X.dirname(a.watchPath);if(this.fsw._getWatchedDir(l).add(a.watchPath),this.fsw._emit(Ct,a.watchPath,c),p=await this._handleDir(l,c,t,o,e,a,h),this.fsw.closed)return;h!==void 0&&this.fsw._symlinkPaths.set(X.resolve(e),h)}else p=this._handleFile(a.watchPath,c,t);return r(),this.fsw._addPathCloser(e,p),!1}catch(c){if(this.fsw._handleError(c))return r(),e}}};Eo.exports=ws});var Lo=O((el,Cs)=>{"use strict";var xs=require("fs"),Z=require("path"),{promisify:Ps}=require("util"),De;try{De=require("fsevents")}catch(s){process.env.CHOKIDAR_PRINT_FSEVENTS_REQUIRE_ERROR&&console.error(s)}if(De){let s=process.version.match(/v(\d+)\.(\d+)/);if(s&&s[1]&&s[2]){let e=Number.parseInt(s[1],10),t=Number.parseInt(s[2],10);e===8&&t<16&&(De=void 0)}}var{EV_ADD:vs,EV_CHANGE:wa,EV_ADD_DIR:To,EV_UNLINK:At,EV_ERROR:va,STR_DATA:ya,STR_END:ba,FSEVENT_CREATED:_a,FSEVENT_MODIFIED:ka,FSEVENT_DELETED:xa,FSEVENT_MOVED:Pa,FSEVENT_UNKNOWN:Ca,FSEVENT_FLAG_MUST_SCAN_SUBDIRS:Sa,FSEVENT_TYPE_FILE:Ra,FSEVENT_TYPE_DIRECTORY:Xe,FSEVENT_TYPE_SYMLINK:Fo,ROOT_GLOBSTAR:Io,DIR_SUFFIX:Ea,DOT_SLASH:$o,FUNCTION_TYPE:ys,EMPTY_FN:Aa,IDENTITY_FN:Ta}=Pt(),Ia=s=>isNaN(s)?{}:{depth:s},_s=Ps(xs.stat),$a=Ps(xs.lstat),Mo=Ps(xs.realpath),Ma={stat:_s,lstat:$a},Ce=new Map,Da=10,Fa=new Set([69888,70400,71424,72704,73472,131328,131840,262912]),La=(s,e)=>({stop:De.watch(s,e)});function Ha(s,e,t,n){let o=Z.extname(e)?Z.dirname(e):e,i=Z.dirname(o),r=Ce.get(o);Na(i)&&(o=i);let a=Z.resolve(s),c=a!==e,d=(h,l,f)=>{c&&(h=h.replace(e,a)),(h===a||!h.indexOf(a+Z.sep))&&t(h,l,f)},p=!1;for(let h of Ce.keys())if(e.indexOf(Z.resolve(h)+Z.sep)===0){o=h,r=Ce.get(o),p=!0;break}return r||p?r.listeners.add(d):(r={listeners:new Set([d]),rawEmitter:n,watcher:La(o,(h,l)=>{if(!r.listeners.size||l&Sa)return;let f=De.getInfo(h,l);r.listeners.forEach(v=>{v(h,l,f)}),r.rawEmitter(f.event,h,f)})},Ce.set(o,r)),()=>{let h=r.listeners;if(h.delete(d),!h.size&&(Ce.delete(o),r.watcher))return r.watcher.stop().then(()=>{r.rawEmitter=r.watcher=void 0,Object.freeze(r)})}}var Na=s=>{let e=0;for(let t of Ce.keys())if(t.indexOf(s)===0&&(e++,e>=Da))return!0;return!1},Ba=()=>De&&Ce.size<128,bs=(s,e)=>{let t=0;for(;!s.indexOf(e)&&(s=Z.dirname(s))!==e;)t++;return t},Do=(s,e)=>s.type===Xe&&e.isDirectory()||s.type===Fo&&e.isSymbolicLink()||s.type===Ra&&e.isFile(),ks=class{constructor(e){this.fsw=e}checkIgnored(e,t){let n=this.fsw._ignoredPaths;if(this.fsw._isIgnored(e,t))return n.add(e),t&&t.isDirectory()&&n.add(e+Io),!0;n.delete(e),n.delete(e+Io)}addOrChange(e,t,n,o,i,r,a,c){let d=i.has(r)?wa:vs;this.handleEvent(d,e,t,n,o,i,r,a,c)}async checkExists(e,t,n,o,i,r,a,c){try{let d=await _s(e);if(this.fsw.closed)return;Do(a,d)?this.addOrChange(e,t,n,o,i,r,a,c):this.handleEvent(At,e,t,n,o,i,r,a,c)}catch(d){d.code==="EACCES"?this.addOrChange(e,t,n,o,i,r,a,c):this.handleEvent(At,e,t,n,o,i,r,a,c)}}handleEvent(e,t,n,o,i,r,a,c,d){if(!(this.fsw.closed||this.checkIgnored(t)))if(e===At){let p=c.type===Xe;(p||r.has(a))&&this.fsw._remove(i,a,p)}else{if(e===vs){if(c.type===Xe&&this.fsw._getWatchedDir(t),c.type===Fo&&d.followSymlinks){let h=d.depth===void 0?void 0:bs(n,o)+1;return this._addToFsEvents(t,!1,!0,h)}this.fsw._getWatchedDir(i).add(a)}let p=c.type===Xe?e+Ea:e;this.fsw._emit(p,t),p===To&&this._addToFsEvents(t,!1,!0)}}_watchWithFsEvents(e,t,n,o){if(this.fsw.closed||this.fsw._isIgnored(e))return;let i=this.fsw.options,a=Ha(e,t,async(c,d,p)=>{if(this.fsw.closed||i.depth!==void 0&&bs(c,t)>i.depth)return;let h=n(Z.join(e,Z.relative(e,c)));if(o&&!o(h))return;let l=Z.dirname(h),f=Z.basename(h),v=this.fsw._getWatchedDir(p.type===Xe?h:l);if(Fa.has(d)||p.event===Ca)if(typeof i.ignored===ys){let y;try{y=await _s(h)}catch{}if(this.fsw.closed||this.checkIgnored(h,y))return;Do(p,y)?this.addOrChange(h,c,t,l,v,f,p,i):this.handleEvent(At,h,c,t,l,v,f,p,i)}else this.checkExists(h,c,t,l,v,f,p,i);else switch(p.event){case _a:case ka:return this.addOrChange(h,c,t,l,v,f,p,i);case xa:case Pa:return this.checkExists(h,c,t,l,v,f,p,i)}},this.fsw._emitRaw);return this.fsw._emitReady(),a}async _handleFsEventsSymlink(e,t,n,o){if(!(this.fsw.closed||this.fsw._symlinkPaths.has(t))){this.fsw._symlinkPaths.set(t,!0),this.fsw._incrReadyCount();try{let i=await Mo(e);if(this.fsw.closed)return;if(this.fsw._isIgnored(i))return this.fsw._emitReady();this.fsw._incrReadyCount(),this._addToFsEvents(i||e,r=>{let a=e;return i&&i!==$o?a=r.replace(i,e):r!==$o&&(a=Z.join(e,r)),n(a)},!1,o)}catch(i){if(this.fsw._handleError(i))return this.fsw._emitReady()}}}emitAdd(e,t,n,o,i){let r=n(e),a=t.isDirectory(),c=this.fsw._getWatchedDir(Z.dirname(r)),d=Z.basename(r);a&&this.fsw._getWatchedDir(r),!c.has(d)&&(c.add(d),(!o.ignoreInitial||i===!0)&&this.fsw._emit(a?To:vs,r,t))}initWatch(e,t,n,o){if(this.fsw.closed)return;let i=this._watchWithFsEvents(n.watchPath,Z.resolve(e||n.watchPath),o,n.globFilter);this.fsw._addPathCloser(t,i)}async _addToFsEvents(e,t,n,o){if(this.fsw.closed)return;let i=this.fsw.options,r=typeof t===ys?t:Ta,a=this.fsw._getWatchHelpers(e);try{let c=await Ma[a.statMethod](a.watchPath);if(this.fsw.closed)return;if(this.fsw._isIgnored(a.watchPath,c))throw null;if(c.isDirectory()){if(a.globFilter||this.emitAdd(r(e),c,r,i,n),o&&o>i.depth)return;this.fsw._readdirp(a.watchPath,{fileFilter:d=>a.filterPath(d),directoryFilter:d=>a.filterDir(d),...Ia(i.depth-(o||0))}).on(ya,d=>{if(this.fsw.closed||d.stats.isDirectory()&&!a.filterPath(d))return;let p=Z.join(a.watchPath,d.path),{fullPath:h}=d;if(a.followSymlinks&&d.stats.isSymbolicLink()){let l=i.depth===void 0?void 0:bs(p,Z.resolve(a.watchPath))+1;this._handleFsEventsSymlink(p,h,r,l)}else this.emitAdd(p,d.stats,r,i,n)}).on(va,Aa).on(ba,()=>{this.fsw._emitReady()})}else this.emitAdd(a.watchPath,c,r,i,n),this.fsw._emitReady()}catch(c){(!c||this.fsw._handleError(c))&&(this.fsw._emitReady(),this.fsw._emitReady())}if(i.persistent&&n!==!0)if(typeof t===ys)this.initWatch(void 0,e,a,r);else{let c;try{c=await Mo(a.watchPath)}catch{}this.initWatch(c,e,a,r)}}};Cs.exports=ks;Cs.exports.canUse=Ba});var js=O(Os=>{"use strict";var{EventEmitter:Oa}=require("events"),Ns=require("fs"),j=require("path"),{promisify:qo}=require("util"),ja=kn(),Is=An().default,Wa=Fn(),Ss=rs(),qa=vo(),Ua=ns(),Ga=Ao(),Ho=Lo(),{EV_ALL:Rs,EV_READY:za,EV_ADD:Tt,EV_CHANGE:Ze,EV_UNLINK:No,EV_ADD_DIR:Va,EV_UNLINK_DIR:Ka,EV_RAW:Ya,EV_ERROR:Es,STR_CLOSE:Qa,STR_END:Xa,BACK_SLASH_RE:Za,DOUBLE_SLASH_RE:Bo,SLASH_OR_BACK_SLASH_RE:Ja,DOT_RE:ec,REPLACER_RE:tc,SLASH:As,SLASH_SLASH:sc,BRACE_START:nc,BANG:$s,ONE_DOT:Uo,TWO_DOTS:oc,GLOBSTAR:rc,SLASH_GLOBSTAR:Ts,ANYMATCH_OPTS:Ms,STRING_TYPE:Bs,FUNCTION_TYPE:ic,EMPTY_STR:Ds,EMPTY_FN:ac,isWindows:cc,isMacos:lc,isIBMi:dc}=Pt(),pc=qo(Ns.stat),uc=qo(Ns.readdir),Fs=(s=[])=>Array.isArray(s)?s:[s],Go=(s,e=[])=>(s.forEach(t=>{Array.isArray(t)?Go(t,e):e.push(t)}),e),Oo=s=>{let e=Go(Fs(s));if(!e.every(t=>typeof t===Bs))throw new TypeError(`Non-string provided as watch path: ${e}`);return e.map(zo)},jo=s=>{let e=s.replace(Za,As),t=!1;for(e.startsWith(sc)&&(t=!0);e.match(Bo);)e=e.replace(Bo,As);return t&&(e=As+e),e},zo=s=>jo(j.normalize(jo(s))),Wo=(s=Ds)=>e=>typeof e!==Bs?e:zo(j.isAbsolute(e)?e:j.join(s,e)),hc=(s,e)=>j.isAbsolute(s)?s:s.startsWith($s)?$s+j.join(e,s.slice(1)):j.join(e,s),he=(s,e)=>s[e]===void 0,Ls=class{constructor(e,t){this.path=e,this._removeWatcher=t,this.items=new Set}add(e){let{items:t}=this;t&&e!==Uo&&e!==oc&&t.add(e)}async remove(e){let{items:t}=this;if(!t||(t.delete(e),t.size>0))return;let n=this.path;try{await uc(n)}catch{this._removeWatcher&&this._removeWatcher(j.dirname(n),j.basename(n))}}has(e){let{items:t}=this;if(t)return t.has(e)}getChildren(){let{items:e}=this;if(e)return[...e.values()]}dispose(){this.items.clear(),delete this.path,delete this._removeWatcher,delete this.items,Object.freeze(this)}},fc="stat",gc="lstat",Hs=class{constructor(e,t,n,o){this.fsw=o,this.path=e=e.replace(tc,Ds),this.watchPath=t,this.fullWatchPath=j.resolve(t),this.hasGlob=t!==e,e===Ds&&(this.hasGlob=!1),this.globSymlink=this.hasGlob&&n?void 0:!1,this.globFilter=this.hasGlob?Is(e,void 0,Ms):!1,this.dirParts=this.getDirParts(e),this.dirParts.forEach(i=>{i.length>1&&i.pop()}),this.followSymlinks=n,this.statMethod=n?fc:gc}checkGlobSymlink(e){return this.globSymlink===void 0&&(this.globSymlink=e.fullParentDir===this.fullWatchPath?!1:{realPath:e.fullParentDir,linkPath:this.fullWatchPath}),this.globSymlink?e.fullPath.replace(this.globSymlink.realPath,this.globSymlink.linkPath):e.fullPath}entryPath(e){return j.join(this.watchPath,j.relative(this.watchPath,this.checkGlobSymlink(e)))}filterPath(e){let{stats:t}=e;if(t&&t.isSymbolicLink())return this.filterDir(e);let n=this.entryPath(e);return(this.hasGlob&&typeof this.globFilter===ic?this.globFilter(n):!0)&&this.fsw._isntIgnored(n,t)&&this.fsw._hasReadPermissions(t)}getDirParts(e){if(!this.hasGlob)return[];let t=[];return(e.includes(nc)?qa.expand(e):[e]).forEach(o=>{t.push(j.relative(this.watchPath,o).split(Ja))}),t}filterDir(e){if(this.hasGlob){let t=this.getDirParts(this.checkGlobSymlink(e)),n=!1;this.unmatchedGlob=!this.dirParts.some(o=>o.every((i,r)=>(i===rc&&(n=!0),n||!t[0][r]||Is(i,t[0][r],Ms))))}return!this.unmatchedGlob&&this.fsw._isntIgnored(this.entryPath(e),e.stats)}},It=class extends Oa{constructor(e){super();let t={};e&&Object.assign(t,e),this._watched=new Map,this._closers=new Map,this._ignoredPaths=new Set,this._throttled=new Map,this._symlinkPaths=new Map,this._streams=new Set,this.closed=!1,he(t,"persistent")&&(t.persistent=!0),he(t,"ignoreInitial")&&(t.ignoreInitial=!1),he(t,"ignorePermissionErrors")&&(t.ignorePermissionErrors=!1),he(t,"interval")&&(t.interval=100),he(t,"binaryInterval")&&(t.binaryInterval=300),he(t,"disableGlobbing")&&(t.disableGlobbing=!1),t.enableBinaryInterval=t.binaryInterval!==t.interval,he(t,"useFsEvents")&&(t.useFsEvents=!t.usePolling),Ho.canUse()||(t.useFsEvents=!1),he(t,"usePolling")&&!t.useFsEvents&&(t.usePolling=lc),dc&&(t.usePolling=!0);let o=process.env.CHOKIDAR_USEPOLLING;if(o!==void 0){let c=o.toLowerCase();c==="false"||c==="0"?t.usePolling=!1:c==="true"||c==="1"?t.usePolling=!0:t.usePolling=!!c}let i=process.env.CHOKIDAR_INTERVAL;i&&(t.interval=Number.parseInt(i,10)),he(t,"atomic")&&(t.atomic=!t.usePolling&&!t.useFsEvents),t.atomic&&(this._pendingUnlinks=new Map),he(t,"followSymlinks")&&(t.followSymlinks=!0),he(t,"awaitWriteFinish")&&(t.awaitWriteFinish=!1),t.awaitWriteFinish===!0&&(t.awaitWriteFinish={});let r=t.awaitWriteFinish;r&&(r.stabilityThreshold||(r.stabilityThreshold=2e3),r.pollInterval||(r.pollInterval=100),this._pendingWrites=new Map),t.ignored&&(t.ignored=Fs(t.ignored));let a=0;this._emitReady=()=>{a++,a>=this._readyCount&&(this._emitReady=ac,this._readyEmitted=!0,process.nextTick(()=>this.emit(za)))},this._emitRaw=(...c)=>this.emit(Ya,...c),this._readyEmitted=!1,this.options=t,t.useFsEvents?this._fsEventsHandler=new Ho(this):this._nodeFsHandler=new Ga(this),Object.freeze(t)}add(e,t,n){let{cwd:o,disableGlobbing:i}=this.options;this.closed=!1;let r=Oo(e);return o&&(r=r.map(a=>{let c=hc(a,o);return i||!Ss(a)?c:Ua(c)})),r=r.filter(a=>a.startsWith($s)?(this._ignoredPaths.add(a.slice(1)),!1):(this._ignoredPaths.delete(a),this._ignoredPaths.delete(a+Ts),this._userIgnored=void 0,!0)),this.options.useFsEvents&&this._fsEventsHandler?(this._readyCount||(this._readyCount=r.length),this.options.persistent&&(this._readyCount+=r.length),r.forEach(a=>this._fsEventsHandler._addToFsEvents(a))):(this._readyCount||(this._readyCount=0),this._readyCount+=r.length,Promise.all(r.map(async a=>{let c=await this._nodeFsHandler._addToNodeFs(a,!n,0,0,t);return c&&this._emitReady(),c})).then(a=>{this.closed||a.filter(c=>c).forEach(c=>{this.add(j.dirname(c),j.basename(t||c))})})),this}unwatch(e){if(this.closed)return this;let t=Oo(e),{cwd:n}=this.options;return t.forEach(o=>{!j.isAbsolute(o)&&!this._closers.has(o)&&(n&&(o=j.join(n,o)),o=j.resolve(o)),this._closePath(o),this._ignoredPaths.add(o),this._watched.has(o)&&this._ignoredPaths.add(o+Ts),this._userIgnored=void 0}),this}close(){if(this.closed)return this._closePromise;this.closed=!0,this.removeAllListeners();let e=[];return this._closers.forEach(t=>t.forEach(n=>{let o=n();o instanceof Promise&&e.push(o)})),this._streams.forEach(t=>t.destroy()),this._userIgnored=void 0,this._readyCount=0,this._readyEmitted=!1,this._watched.forEach(t=>t.dispose()),["closers","watched","streams","symlinkPaths","throttled"].forEach(t=>{this[`_${t}`].clear()}),this._closePromise=e.length?Promise.all(e).then(()=>{}):Promise.resolve(),this._closePromise}getWatched(){let e={};return this._watched.forEach((t,n)=>{let o=this.options.cwd?j.relative(this.options.cwd,n):n;e[o||Uo]=t.getChildren().sort()}),e}emitWithAll(e,t){this.emit(...t),e!==Es&&this.emit(Rs,...t)}async _emit(e,t,n,o,i){if(this.closed)return;let r=this.options;cc&&(t=j.normalize(t)),r.cwd&&(t=j.relative(r.cwd,t));let a=[e,t];i!==void 0?a.push(n,o,i):o!==void 0?a.push(n,o):n!==void 0&&a.push(n);let c=r.awaitWriteFinish,d;if(c&&(d=this._pendingWrites.get(t)))return d.lastChange=new Date,this;if(r.atomic){if(e===No)return this._pendingUnlinks.set(t,a),setTimeout(()=>{this._pendingUnlinks.forEach((p,h)=>{this.emit(...p),this.emit(Rs,...p),this._pendingUnlinks.delete(h)})},typeof r.atomic=="number"?r.atomic:100),this;e===Tt&&this._pendingUnlinks.has(t)&&(e=a[0]=Ze,this._pendingUnlinks.delete(t))}if(c&&(e===Tt||e===Ze)&&this._readyEmitted){let p=(h,l)=>{h?(e=a[0]=Es,a[1]=h,this.emitWithAll(e,a)):l&&(a.length>2?a[2]=l:a.push(l),this.emitWithAll(e,a))};return this._awaitWriteFinish(t,c.stabilityThreshold,e,p),this}if(e===Ze&&!this._throttle(Ze,t,50))return this;if(r.alwaysStat&&n===void 0&&(e===Tt||e===Va||e===Ze)){let p=r.cwd?j.join(r.cwd,t):t,h;try{h=await pc(p)}catch{}if(!h||this.closed)return;a.push(h)}return this.emitWithAll(e,a),this}_handleError(e){let t=e&&e.code;return e&&t!=="ENOENT"&&t!=="ENOTDIR"&&(!this.options.ignorePermissionErrors||t!=="EPERM"&&t!=="EACCES")&&this.emit(Es,e),e||this.closed}_throttle(e,t,n){this._throttled.has(e)||this._throttled.set(e,new Map);let o=this._throttled.get(e),i=o.get(t);if(i)return i.count++,!1;let r,a=()=>{let d=o.get(t),p=d?d.count:0;return o.delete(t),clearTimeout(r),d&&clearTimeout(d.timeoutObject),p};r=setTimeout(a,n);let c={timeoutObject:r,clear:a,count:0};return o.set(t,c),c}_incrReadyCount(){return this._readyCount++}_awaitWriteFinish(e,t,n,o){let i,r=e;this.options.cwd&&!j.isAbsolute(e)&&(r=j.join(this.options.cwd,e));let a=new Date,c=d=>{Ns.stat(r,(p,h)=>{if(p||!this._pendingWrites.has(e)){p&&p.code!=="ENOENT"&&o(p);return}let l=Number(new Date);d&&h.size!==d.size&&(this._pendingWrites.get(e).lastChange=l);let f=this._pendingWrites.get(e);l-f.lastChange>=t?(this._pendingWrites.delete(e),o(void 0,h)):i=setTimeout(c,this.options.awaitWriteFinish.pollInterval,h)})};this._pendingWrites.has(e)||(this._pendingWrites.set(e,{lastChange:a,cancelWait:()=>(this._pendingWrites.delete(e),clearTimeout(i),n)}),i=setTimeout(c,this.options.awaitWriteFinish.pollInterval))}_getGlobIgnored(){return[...this._ignoredPaths.values()]}_isIgnored(e,t){if(this.options.atomic&&ec.test(e))return!0;if(!this._userIgnored){let{cwd:n}=this.options,o=this.options.ignored,i=o&&o.map(Wo(n)),r=Fs(i).filter(c=>typeof c===Bs&&!Ss(c)).map(c=>c+Ts),a=this._getGlobIgnored().map(Wo(n)).concat(i,r);this._userIgnored=Is(a,void 0,Ms)}return this._userIgnored([e,t])}_isntIgnored(e,t){return!this._isIgnored(e,t)}_getWatchHelpers(e,t){let n=t||this.options.disableGlobbing||!Ss(e)?e:Wa(e),o=this.options.followSymlinks;return new Hs(e,n,o,this)}_getWatchedDir(e){this._boundRemove||(this._boundRemove=this._remove.bind(this));let t=j.resolve(e);return this._watched.has(t)||this._watched.set(t,new Ls(t,this._boundRemove)),this._watched.get(t)}_hasReadPermissions(e){if(this.options.ignorePermissionErrors)return!0;let n=(e&&Number.parseInt(e.mode,10))&511;return!!(4&Number.parseInt(n.toString(8)[0],10))}_remove(e,t,n){let o=j.join(e,t),i=j.resolve(o);if(n=n??(this._watched.has(o)||this._watched.has(i)),!this._throttle("remove",o,100))return;!n&&!this.options.useFsEvents&&this._watched.size===1&&this.add(e,t,!0),this._getWatchedDir(o).getChildren().forEach(l=>this._remove(o,l));let c=this._getWatchedDir(e),d=c.has(t);c.remove(t),this._symlinkPaths.has(i)&&this._symlinkPaths.delete(i);let p=o;if(this.options.cwd&&(p=j.relative(this.options.cwd,o)),this.options.awaitWriteFinish&&this._pendingWrites.has(p)&&this._pendingWrites.get(p).cancelWait()===Tt)return;this._watched.delete(o),this._watched.delete(i);let h=n?Ka:No;d&&!this._isIgnored(o)&&this._emit(h,o),this.options.useFsEvents||this._closePath(o)}_closePath(e){this._closeFile(e);let t=j.dirname(e);this._getWatchedDir(t).remove(j.basename(e))}_closeFile(e){let t=this._closers.get(e);t&&(t.forEach(n=>n()),this._closers.delete(e))}_addPathCloser(e,t){if(!t)return;let n=this._closers.get(e);n||(n=[],this._closers.set(e,n)),n.push(t)}_readdirp(e,t){if(this.closed)return;let n={type:Rs,alwaysStat:!0,lstat:!0,...t},o=ja(e,n);return this._streams.add(o),o.once(Qa,()=>{o=void 0}),o.once(Xa,()=>{o&&(this._streams.delete(o),o=void 0)}),o}};Os.FSWatcher=It;var mc=(s,e)=>{let t=new It(e);return t.add(s),t};Os.watch=mc});var xc={};rr(xc,{activate:()=>bc,deactivate:()=>_c});module.exports=ir(xc);var u=G(require("vscode")),rt=G(require("path"));var L=G(require("vscode"));var Ae=G(require("fs")),ye=G(require("path")),Ks=G(require("crypto")),Oe=new Map;function Vs(s){let e=ye.join(s,".projectmemory","identity.json");try{if(!Ae.existsSync(e))return null;let t=Ae.readFileSync(e,"utf-8"),n=JSON.parse(t);return!n.workspace_id||!n.workspace_path?null:{workspaceId:n.workspace_id,workspaceName:ye.basename(n.workspace_path),projectPath:n.workspace_path}}catch{return null}}function oe(s){let e=ye.normalize(s);if(console.log("[PM Identity] Resolving identity for:",e),Oe.has(e)){let n=Oe.get(e);return console.log("[PM Identity] Cache hit:",n?.workspaceId??"null"),n??null}let t=Vs(e);if(t)return console.log("[PM Identity] Found at root:",t.workspaceId),Oe.set(e,t),t;try{let n=Ae.readdirSync(e,{withFileTypes:!0});console.log("[PM Identity] Scanning",n.length,"entries in root");for(let o of n){if(!o.isDirectory()||o.name.startsWith(".")||o.name==="node_modules")continue;let i=ye.join(e,o.name);if(t=Vs(i),t)return console.log("[PM Identity] Found in subdir:",o.name,"->",t.workspaceId),Oe.set(e,t),t}}catch(n){console.log("[PM Identity] Scan error:",n)}return console.log("[PM Identity] No identity found, caching null"),Oe.set(e,null),null}function je(s){let e=ye.normalize(s).toLowerCase(),t=Ks.createHash("sha256").update(e).digest("hex").substring(0,12);return`${ye.basename(s).replace(/[^a-zA-Z0-9-_]/g,"-")}-${t}`}function qt(s,...e){return L.workspace.getConfiguration("projectMemory").get("showNotifications",!0)?L.window.showInformationMessage(s,...e):Promise.resolve(void 0)}var pt=class{constructor(e,t,n){this._extensionUri=e;this._dataRoot=t,this._agentsRoot=n}static viewType="projectMemory.dashboardView";_view;_dataRoot;_agentsRoot;_disposables=[];dispose(){for(;this._disposables.length;){let e=this._disposables.pop();e&&e.dispose()}}getWorkspaceId(){let e=L.workspace.workspaceFolders?.[0];if(!e)return null;let t=e.uri.fsPath;console.log("[PM Debug] getWorkspaceId for fsPath:",t);let n=oe(t);if(n)return console.log("[PM Debug] Found identity:",n.workspaceId,"from",n.projectPath),n.workspaceId;let o=je(t);return console.log("[PM Debug] Using fallback ID:",o),o}getWorkspaceName(){let e=L.workspace.workspaceFolders?.[0];if(!e)return"No workspace";let t=oe(e.uri.fsPath);return t?t.workspaceName:e.name}resolveWebviewView(e,t,n){this.dispose(),this._view=e,e.webview.options={enableScripts:!0,localResourceRoots:[L.Uri.joinPath(this._extensionUri,"webview","dist"),L.Uri.joinPath(this._extensionUri,"resources")]},e.webview.html=this._getHtmlForWebview(e.webview),this._disposables.push(e.onDidDispose(()=>{this._view=void 0})),this._disposables.push(e.webview.onDidReceiveMessage(async o=>{switch(console.log("Received message from webview:",o),o.type){case"openFile":let{filePath:i,line:r}=o.data;L.commands.executeCommand("projectMemory.openFile",i,r);break;case"runCommand":let{command:a}=o.data;console.log("Executing command:",a);try{await L.commands.executeCommand(a),console.log("Command executed successfully")}catch(x){console.error("Command execution failed:",x),L.window.showErrorMessage(`Command failed: ${x}`)}break;case"openExternal":let{url:c}=o.data;console.log("Opening dashboard panel:",c),L.commands.executeCommand("projectMemory.openDashboardPanel",c);break;case"openPlan":let{planId:d,workspaceId:p}=o.data,h=`http://localhost:5173/workspace/${p}/plan/${d}`;console.log("Opening plan:",h),L.commands.executeCommand("projectMemory.openDashboardPanel",h);break;case"openPlanRoute":await this.openPlanRoute(o.data);break;case"planAction":await this.runPlanAction(o.data);break;case"isolateServer":await L.commands.executeCommand("projectMemory.isolateServer");break;case"copyToClipboard":let{text:l}=o.data;await L.env.clipboard.writeText(l),qt(`Copied to clipboard: ${l}`);break;case"showNotification":let{level:f,text:v}=o.data;f==="error"?L.window.showErrorMessage(v):f==="warning"?L.window.showWarningMessage(v):qt(v);break;case"revealInExplorer":let{path:y}=o.data;L.commands.executeCommand("revealInExplorer",L.Uri.file(y));break;case"getConfig":this.postMessage({type:"config",data:{dataRoot:this._dataRoot,agentsRoot:this._agentsRoot,workspaceFolders:L.workspace.workspaceFolders?.map(x=>({name:x.name,path:x.uri.fsPath}))||[]}});break;case"ready":this.postMessage({type:"init",data:{dataRoot:this._dataRoot,agentsRoot:this._agentsRoot}});break}}))}postMessage(e){this._view&&this._view.webview.postMessage(e)}updateConfig(e,t){this._dataRoot=e,this._agentsRoot=t,this.postMessage({type:"configUpdated",data:{dataRoot:e,agentsRoot:t}})}getApiPort(){let e=L.workspace.getConfiguration("projectMemory");return e.get("serverPort")||e.get("apiPort")||3001}getDashboardUrl(){return"http://localhost:5173"}async pickPlan(){let e=this.getWorkspaceId();if(!e)return L.window.showErrorMessage("No workspace is open."),null;let t=this.getApiPort();try{let n=await fetch(`http://localhost:${t}/api/plans/workspace/${e}`);if(!n.ok)return L.window.showErrorMessage("Failed to load plans from the dashboard server."),null;let o=await n.json(),i=Array.isArray(o.plans)?o.plans:[];if(i.length===0)return L.window.showInformationMessage("No plans found for this workspace."),null;let r=await L.window.showQuickPick(i.map(a=>{let c=a.id||a.plan_id||"unknown";return{label:a.title||c,description:a.status||"unknown",detail:c}}),{placeHolder:"Select a plan"});return!r||!r.detail?null:{workspaceId:e,planId:r.detail}}catch(n){return L.window.showErrorMessage(`Failed to load plans: ${n}`),null}}async openPlanRoute(e){let t=await this.pickPlan();if(!t)return;let{workspaceId:n,planId:o}=t,i=`${this.getDashboardUrl()}/workspace/${n}/plan/${o}`;e.route==="context"?i+="/context":e.route==="build-scripts"&&(i+="/build-scripts"),e.query&&(i+=`?${e.query}`),L.commands.executeCommand("projectMemory.openDashboardPanel",i)}async runPlanAction(e){let t=await this.pickPlan();if(!t)return;let{workspaceId:n,planId:o}=t,i=e.action==="archive"?"Archive":"Resume";if(e.action==="archive"&&await L.window.showWarningMessage(`Archive plan ${o}?`,{modal:!0},"Archive")!=="Archive")return;let r=this.getApiPort();try{let a=await fetch(`http://localhost:${r}/api/plans/${n}/${o}/${e.action}`,{method:"POST"});if(!a.ok){let d=await a.text();L.window.showErrorMessage(`Failed to ${e.action} plan: ${d}`);return}qt(`${i}d plan ${o}`);let c=`${this.getDashboardUrl()}/workspace/${n}/plan/${o}`;L.commands.executeCommand("projectMemory.openDashboardPanel",c)}catch(a){L.window.showErrorMessage(`Failed to ${e.action} plan: ${a}`)}}_getHtmlForWebview(e){let t=ar(),n=L.workspace.getConfiguration("projectMemory"),o=n.get("serverPort")||n.get("apiPort")||3001,i="http://localhost:5173",r=this.getWorkspaceId()||"",a=this.getWorkspaceName(),c=JSON.stringify(this._dataRoot),d={dashboard:'<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect width="7" height="9" x="3" y="3" rx="1"/><rect width="7" height="5" x="14" y="3" rx="1"/><rect width="7" height="9" x="14" y="12" rx="1"/><rect width="7" height="5" x="3" y="16" rx="1"/></svg>',knowledgeBase:'<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 19.5v-15A2.5 2.5 0 0 1 6.5 2H20v20H6.5a2.5 2.5 0 0 1-2.5-2.5Z"/><path d="M6.5 15.5H20"/></svg>',contextFiles:'<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M14.5 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7.5L14.5 2z"/><polyline points="14 2 14 8 20 8"/></svg>',contextFilesGrid:'<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect width="18" height="18" x="3" y="3" rx="2"/><path d="M9 3v18"/><path d="M3 15h6"/><path d="M15 3v18"/><path d="M15 9h6"/></svg>',agents:'<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><line x1="19" x2="19" y1="8" y2="14"/><line x1="22" x2="16" y1="11" y2="11"/></svg>',syncHistory:'<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m21 16-4 4-4-4"/><path d="M17 20V4"/><path d="m3 8 4-4 4 4"/><path d="M7 4v16"/></svg>',diagnostics:'<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><path d="M12 16v-4"/><path d="M12 8h.01"/></svg>',newTemplate:'<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M5 12h14"/><path d="M12 5v14"/></svg>',resumePlan:'<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M5 3l14 9-14 9V3z"/></svg>',archive:'<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect width="20" height="5" x="2" y="3" rx="1"/><path d="M4 8v11a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8"/><path d="M10 12h4"/></svg>',addContextNote:'<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M15.5 3H5a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V8.5L15.5 3z"/><path d="M15 3v6h6"/><path d="M9 18h6"/><path d="M10 14h4"/></svg>',researchNote:'<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="m15 18-6-6 6-6"/><path d="M15 12h-9"/></svg>',createNewPlan:'<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M11 20H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h3.9a2 2 0 0 1 1.69.9l.81 1.2a2 2 0 0 0 1.67.9H20a2 2 0 0 1 2 2v4"/><circle cx="18" cy="18" r="3"/><path d="M18 15v6"/><path d="M15 18h6"/></svg>',deployAgents:'<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M19 8v9"/><path d="m16 11 3-3 3 3"/></svg>',deployInstructions:'<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 19.5v-15A2.5 2.5 0 0 1 6.5 2H20v20H6.5a2.5 2.5 0 0 1-2.5-2.5Z"/><path d="M6.5 15.5H20"/><path d="M14 11V7"/><path d="m11 10 3-3 3 3"/></svg>',deployPrompts:'<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m7 11 2-2-2-2"/><path d="M11 9h4"/><rect width="18" height="18" x="3" y="3" rx="2"/><path d="M12 15v4"/><path d="m9 18 3-3 3 3"/></svg>',configureDefaults:'<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12.22 2h-.44a2 2 0 0 0-2 2v.18a2 2 0 0 1-1 1.73l-.43.25a2 2 0 0 1-2 0l-.15-.08a2 2 0 0 0-2.73.73l-.22.38a2 2 0 0 0 .73 2.73l.15.1a2 2 0 0 1 1 1.72v.51a2 2 0 0 1-1 1.74l-.15.09a2 2 0 0 0-.73 2.73l.22.38a2 2 0 0 0 2.73.73l.15-.08a2 2 0 0 1 2 0l.43.25a2 2 0 0 1 1 1.73V20a2 2 0 0 0 2 2h.44a2 2 0 0 0 2-2v-.18a2 2 0 0 1 1-1.73l.43-.25a2 2 0 0 1 2 0l.15.08a2 2 0 0 0 2.73-.73l.22-.39a2 2 0 0 0-.73-2.73l-.15-.08a2 2 0 0 1-1-1.74v-.5a2 2 0 0 1 1-1.74l.15-.09a2 2 0 0 0 .73-2.73l-.22-.38a2 2 0 0 0-2.73-.73l-.15.08a2 2 0 0 1-2 0l-.43-.25a2 2 0 0 1-1-1.73V4a2 2 0 0 0-2-2z"/><circle cx="12" cy="12" r="3"/><path d="m9 12 2 2 4-4"/></svg>',deployAllDefaults:'<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 10V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l2-1.14"/><path d="M16.5 9.4 7.55 4.24"/><polyline points="3.29 7 12 12 20.71 7"/><line x1="12" y1="22" x2="12" y2="12"/><path d="M17 13h5"/><path d="M17 17h5"/><path d="M17 21h5"/></svg>',handoffEvent:'<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="m16 13 4 4-4 4"/><path d="M20 17H4a2 2 0 0 1-2-2V5"/></svg>',noteEvent:'<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"/><path d="M18.5 2.5a2.121 2.121 0 1 1 3 3L12 15l-4 1 1-4 9.5-9.5z"/></svg>',stepUpdate:'<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="m9 11 3 3L22 4"/><path d="M21 12v7a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11"/></svg>',searchBox:'<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="11" cy="11" r="8"/><path d="m21 21-4.3-4.3"/></svg>',buildScript:'<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="16 18 22 12 16 6"/><polyline points="8 6 2 12 8 18"/></svg>',runButton:'<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polygon points="5 3 19 12 5 21 5 3"/></svg>',stopStale:'<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect width="10" height="10" x="7" y="7" rx="2"/></svg>',healthBadge:'<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M22 12h-4l-3 9L9 3l-3 9H2"/></svg>',dataRoot:'<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><polyline points="7 10 12 15 17 10"/><line x1="12" x2="12" y1="3" y2="15"/></svg>',agentHandoff:'<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><polyline points="16 11 18 13 22 9"/></svg>',isolate:'<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="3" width="18" height="18" rx="2"/><path d="M9 3v18"/><path d="M15 3v18"/></svg>'},p=JSON.stringify(d);return`<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
\u26A0\uFE0F ${d.warning}
`)}catch(d){let p=d instanceof Error?d.message:String(d);t.markdown(`\u274C Handoff failed: ${p}`)}return{metadata:{command:"handoff",targetAgent:r,planId:a}}}async handleStatusCommand(e,t,n){if(!this.workspaceId)return t.markdown("\u26A0\uFE0F Workspace not registered."),{metadata:{command:"status"}};t.markdown(`\u{1F4CA} **Project Memory Status**
...
`);else for(let c of a){let d=this.getStatusEmoji(c.status),p=c.done_steps??c.progress?.done??0,h=c.total_steps??c.progress?.total??0,l=c.plan_id||c.id;t.markdown(`${d} **${c.title}**${l?` (\`${l}\`)`:""}
`),h>0&&t.markdown(`   Progress: ${p}/${h} steps
...
`),t.markdown("- Use `/status` to check current progress\n"),t.markdown("- Use `/context` to get workspace information\n")}return{metadata:{command:"default"}}}provideFollowups(e,t,n){let o=e.metadata,i=o?.command,r=[];switch(i){case"plan":o?.action==="created"&&o?.planId&&r.push({prompt:`/plan show ${o.planId}`,label:"View plan details",command:"plan"}),r.push({prompt:"/status",label:"Check status",command:"status"});break;case"status":r.push({prompt:"/plan list",label:"List all plans",command:"plan"});break;case"help":case"default":r.push({prompt:"/plan list",label:"List plans",command:"plan"}),r.push({prompt:"/status",label:"Check status",command:"status"});break}return r}getStatusEmoji(e){switch(e){case"active":return"\u{1F535}";case"completed":return"\u2705";case"archived":return"\u{1F4E6}";case"blocked":return"\u{1F534}";default:return"\u26AA"}}getStepStatusEmoji(e){switch(e){case"done":return"\u2705";case"active":return"\u{1F504}";case"blocked":return"\u{1F534}";default:return"\u2B1C"}}resetWorkspace(){this.workspaceId=null}dispose(){this.participant.dispose()}};var se=G(require("vscode")),st=class{mcpBridge;workspaceId=null;disposables=[];constructor(e){this.mcpBridge=e,this.registerTools()}resetWorkspace(){this.workspaceId=null}registerTools(){this.disposables.push(se.lm.registerTool("memory_plan",{invoke:async(e,t)=>await this.handlePlan(e,t)})),this.disposables.push(se.lm.registerTool("memory_steps",{invoke:async(e,t)=>await this.handleSteps(e,t)})),this.disposables.push(se.lm.registerTool("memory_context",{invoke:async(e,t)=>await this.handleContext(e,t)}))}async ensureWorkspace(){if(this.workspaceId)return this.workspaceId;let e=se.workspace.workspaceFolders?.[0];if(!e)throw new Error("No workspace folder open");let t=await this.mcpBridge.callTool("memory_workspace",{action:"register",workspace_path:e.uri.fsPath});return this.workspaceId=t.workspace_id,this.workspaceId}async handlePlan(e,t){try{if(!this.mcpBridge.isConnected())return this.errorResult("MCP server not connected");let n=await this.ensureWorkspace(),{action:o,planId:i,title:r,description:a,category:c,priority:d,template:p,goals:h,success_criteria:l,includeArchived:f}=e.input,v;switch(o){case"list":let y=await this.mcpBridge.callTool("memory_plan",{action:"list",workspace_id:n,include_archived:f});v={workspace_id:n,plans:y.active_plans||[],total:(y.active_plans||[]).length,message:(y.active_plans||[]).length>0?`Found ${(y.active_plans||[]).length} plan(s)`:'No plans found. Use action "create" to create one.'};break;case"get":if(!i)return this.errorResult("planId is required for get action");v=await this.mcpBridge.callTool("memory_plan",{action:"get",workspace_id:n,plan_id:i});break;case"create":if(!r||!a)return this.errorResult("title and description are required for create action");v=await this.mcpBridge.callTool("memory_plan",{action:"create",workspace_id:n,title:r,description:a,category:c||"feature",priority:d||"medium",template:p,goals:h,success_criteria:l});break;case"archive":if(!i)return this.errorResult("planId is required for archive action");v=await this.mcpBridge.callTool("memory_plan",{action:"archive",workspace_id:n,plan_id:i});break;default:return this.errorResult(`Unknown action: ${o}`)}return new se.LanguageModelToolResult([new se.LanguageModelTextPart(JSON.stringify(v,null,2))])}catch(n){return this.errorResult(n)}}async handleSteps(e,t){try{if(!this.mcpBridge.isConnected())return this.errorResult("MCP server not connected");let n=await this.ensureWorkspace(),{action:o,planId:i,stepIndex:r,status:a,notes:c,updates:d,newSteps:p}=e.input;if(!i)return this.errorResult("planId is required");let h;switch(o){case"update":if(r===void 0||!a)return this.errorResult("stepIndex and status are required for update action");h=await this.mcpBridge.callTool("memory_steps",{action:"update",workspace_id:n,plan_id:i,step_index:r,status:a,notes:c});break;case"batch_update":if(!d||d.length===0)return this.errorResult("updates array is required for batch_update action");h=await this.mcpBridge.callTool("memory_steps",{action:"batch_update",workspace_id:n,plan_id:i,updates:d});break;case"add":if(!p||p.length===0)return this.errorResult("newSteps array is required for add action");h=await this.mcpBridge.callTool("memory_steps",{action:"add",workspace_id:n,plan_id:i,steps:p.map(l=>({...l,status:l.status||"pending"}))});break;default:return this.errorResult(`Unknown action: ${o}`)}return new se.LanguageModelToolResult([new se.LanguageModelTextPart(JSON.stringify(h,null,2))])}catch(n){return this.errorResult(n)}}async handleContext(e,t){try{if(!this.mcpBridge.isConnected())return this.errorResult("MCP server not connected");let n=await this.ensureWorkspace(),{action:o,planId:i,note:r,noteType:a,targetAgent:c,reason:d}=e.input,p;switch(o){case"add_note":if(!i||!r)return this.errorResult("planId and note are required for add_note action");p=await this.mcpBridge.callTool("memory_plan",{action:"add_note",workspace_id:n,plan_id:i,note:r,note_type:a||"info"});break;case"briefing":if(!i)return this.errorResult("planId is required for briefing action");p=await this.mcpBridge.callTool("memory_agent",{action:"get_briefing",workspace_id:n,plan_id:i});break;case"handoff":if(!i||!c||!d)return this.errorResult("planId, targetAgent, and reason are required for handoff action");p=await this.mcpBridge.callTool("memory_agent",{action:"handoff",workspace_id:n,plan_id:i,from_agent:"User",to_agent:c,reason:d});break;case"workspace":p=await this.mcpBridge.callTool("memory_workspace",{action:"info",workspace_id:n});break;default:return this.errorResult(`Unknown action: ${o}`)}return new se.LanguageModelToolResult([new se.LanguageModelTextPart(JSON.stringify(p,null,2))])}catch(n){return this.errorResult(n)}}errorResult(e){let t=e instanceof Error?e.message:String(e);return new se.LanguageModelToolResult([new se.LanguageModelTextPart(JSON.stringify({success:!1,error:t}))])}dispose(){this.disposables.forEach(e=>e.dispose()),this.disposables=[]}};var le,ot,Be,Gs,H,nt,de=null,Re=null,Ee=null;function q(s,...e){return u.workspace.getConfiguration("projectMemory").get("showNotifications",!0)?u.window.showInformationMessage(s,...e):Promise.resolve(void 0)}async function yc(s,e){try{let t=oe(e),n=t?t.projectPath:e,o=await fetch(`http://localhost:${s}/api/workspaces/register`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({workspace_path:n})});if(!o.ok)return null;let r=(await o.json()).workspace;return r?.workspace_id||r?.id||null}catch{return null}}function bc(s){console.log("Project Memory Dashboard extension activating...");let e=u.workspace.getConfiguration("projectMemory"),t=e.get("dataRoot")||Qo(),n=e.get("agentsRoot")||Ne(),o=e.get("promptsRoot"),i=e.get("instructionsRoot"),r=e.get("serverPort")||3001,a=e.get("wsPort")||3002,c=e.get("autoStartServer")??!0,d=e.get("defaultAgents")||[],p=e.get("defaultInstructions")||[],h=e.get("autoDeployOnWorkspaceOpen")??!1;if(nt=new Nt({agentsRoot:n,instructionsRoot:i||jt(),defaultAgents:d,defaultInstructions:p}),h&&u.workspace.workspaceFolders?.[0]){let l=u.workspace.workspaceFolders[0].uri.fsPath;nt.deployToWorkspace(l).then(f=>{(f.agents.length>0||f.instructions.length>0)&&q(`Deployed ${f.agents.length} agents and ${f.instructions.length} instructions`)})}H=new Ht({dataRoot:t,agentsRoot:n,promptsRoot:o,instructionsRoot:i,serverPort:r,wsPort:a}),s.subscriptions.push(H),c&&H.hasServerDirectory()&&H.start().then(async l=>{l?H.isExternalServer?q("Connected to existing Project Memory server"):q("Project Memory API server started"):u.window.showWarningMessage("Failed to start Project Memory server. Click to view logs.","View Logs").then(f=>{f==="View Logs"&&H.showLogs()})}),kc(s,e,t),le=new pt(s.extensionUri,t,n),s.subscriptions.push(u.window.registerWebviewViewProvider("projectMemory.dashboardView",le,{webviewOptions:{retainContextWhenHidden:!0}})),s.subscriptions.push(u.commands.registerCommand("projectMemory.showDashboard",()=>{u.commands.executeCommand("workbench.view.extension.projectMemory")}),u.commands.registerCommand("projectMemory.openDashboardPanel",async l=>{if(!H.isRunning){if(await u.window.showWarningMessage("Project Memory server is not running. Start it first?","Start Server","Cancel")!=="Start Server")return;if(!await u.window.withProgress({location:u.ProgressLocation.Notification,title:"Starting Project Memory server...",cancellable:!1},async()=>await H.start())){u.window.showErrorMessage("Failed to start server. Check logs for details."),H.showLogs();return}}if(!H.isFrontendRunning&&!await u.window.withProgress({location:u.ProgressLocation.Notification,title:"Starting dashboard frontend...",cancellable:!1},async()=>await H.startFrontend())){u.window.showErrorMessage("Failed to start dashboard frontend. Check server logs."),H.showLogs();return}let f=l||"http://localhost:5173";Bt.createOrShow(s.extensionUri,f)}),u.commands.registerCommand("projectMemory.toggleServer",async()=>{H.isRunning?(await H.stopFrontend(),await H.stop(),q("Project Memory server stopped")):await H.start()?q("Project Memory server started"):u.window.showErrorMessage("Failed to start Project Memory server")}),u.commands.registerCommand("projectMemory.startServer",async()=>{if(H.isRunning){q("Server is already running");return}await H.start()?q("Project Memory server started"):(u.window.showErrorMessage("Failed to start server. Check logs for details."),H.showLogs())}),u.commands.registerCommand("projectMemory.stopServer",async()=>{await H.stopFrontend(),await H.stop(),q("Project Memory server stopped")}),u.commands.registerCommand("projectMemory.forceStopExternalServer",async()=>{let f=u.workspace.getConfiguration("projectMemory").get("serverPort")||3001;if(await u.window.showWarningMessage(`Force stop the external server on port ${f}?`,{modal:!0},"Force Stop")!=="Force Stop")return;await H.forceStopExternalServer()?q("External server stopped"):(u.window.showErrorMessage("Failed to stop external server. Check logs for details."),H.showLogs())}),u.commands.registerCommand("projectMemory.restartServer",async()=>{q("Restarting Project Memory server..."),await H.stopFrontend(),await H.restart()?q("Project Memory server restarted"):u.window.showErrorMessage("Failed to restart server")}),u.commands.registerCommand("projectMemory.showServerLogs",()=>{H.showLogs()}),u.commands.registerCommand("projectMemory.isolateServer",async()=>{let l=u.workspace.getConfiguration("projectMemory"),f=l.get("serverPort")||3001,v=f!==3001;if(v)await l.update("serverPort",3001,u.ConfigurationTarget.Workspace),await H.stopFrontend(),await H.stop(),u.window.showInformationMessage("Switching to shared server on port 3001. Reloading window...","Reload").then(y=>{y==="Reload"&&u.commands.executeCommand("workbench.action.reloadWindow")});else{let y=u.workspace.workspaceFolders?.[0];if(!y){u.window.showErrorMessage("No workspace folder open");return}let x=require("crypto").createHash("md5").update(y.uri.fsPath.toLowerCase()).digest("hex"),A=3101+parseInt(x.substring(0,4),16)%99;await l.update("serverPort",A,u.ConfigurationTarget.Workspace),await H.stopFrontend(),await H.stop(),u.window.showInformationMessage(`Switching to isolated server on port ${A}. Reloading window...`,"Reload").then(R=>{R==="Reload"&&u.commands.executeCommand("workbench.action.reloadWindow")})}le?.postMessage({type:"isolateServerStatus",data:{isolated:!v,port:v?3001:f}})}),u.commands.registerCommand("projectMemory.openSettings",async()=>{let l=u.workspace.getConfiguration("projectMemory"),f=l.get("agentsRoot")||Ne(),v=l.get("instructionsRoot")||jt(),y=l.get("promptsRoot")||Xo(),x=await u.window.showQuickPick([{label:"$(person) Configure Default Agents",description:"Select which agents to deploy by default",value:"agents"},{label:"$(book) Configure Default Instructions",description:"Select which instructions to deploy by default",value:"instructions"},{label:"$(file) Configure Default Prompts",description:"Select which prompts to deploy by default",value:"prompts"},{label:"$(gear) Open All Settings",description:"Open VS Code settings for Project Memory",value:"settings"}],{placeHolder:"What would you like to configure?"});if(!x)return;let A=require("fs");if(x.value==="settings"){u.commands.executeCommand("workbench.action.openSettings","@ext:project-memory.project-memory-dashboard");return}if(x.value==="agents"&&f)try{let R=A.readdirSync(f).filter(C=>C.endsWith(".agent.md")).map(C=>C.replace(".agent.md","")),P=l.get("defaultAgents")||[],F=R.map(C=>({label:C,picked:P.length===0||P.includes(C)})),I=await u.window.showQuickPick(F,{canPickMany:!0,placeHolder:"Select default agents (these will be pre-selected when deploying)",title:"Configure Default Agents"});I&&(await l.update("defaultAgents",I.map(C=>C.label),u.ConfigurationTarget.Global),q(`\u2705 Updated default agents (${I.length} selected)`))}catch(R){u.window.showErrorMessage(`Failed to read agents: ${R}`)}if(x.value==="instructions"&&v)try{let R=A.readdirSync(v).filter(C=>C.endsWith(".instructions.md")).map(C=>C.replace(".instructions.md","")),P=l.get("defaultInstructions")||[],F=R.map(C=>({label:C,picked:P.length===0||P.includes(C)})),I=await u.window.showQuickPick(F,{canPickMany:!0,placeHolder:"Select default instructions (these will be pre-selected when deploying)",title:"Configure Default Instructions"});I&&(await l.update("defaultInstructions",I.map(C=>C.label),u.ConfigurationTarget.Global),q(`\u2705 Updated default instructions (${I.length} selected)`))}catch(R){u.window.showErrorMessage(`Failed to read instructions: ${R}`)}if(x.value==="prompts"&&y)try{let R=A.readdirSync(y).filter(C=>C.endsWith(".prompt.md")).map(C=>C.replace(".prompt.md","")),P=l.get("defaultPrompts")||[],F=R.map(C=>({label:C,picked:P.length===0||P.includes(C)})),I=await u.window.showQuickPick(F,{canPickMany:!0,placeHolder:"Select default prompts (these will be pre-selected when deploying)",title:"Configure Default Prompts"});I&&(await l.update("defaultPrompts",I.map(C=>C.label),u.ConfigurationTarget.Global),q(`\u2705 Updated default prompts (${I.length} selected)`))}catch(R){u.window.showErrorMessage(`Failed to read prompts: ${R}`)}}),u.commands.registerCommand("projectMemory.createPlan",async()=>{let l=u.workspace.workspaceFolders;if(!l){u.window.showErrorMessage("No workspace folder open");return}let f=await u.window.showQuickPick([{label:"\u{1F9E0} Brainstorm First",description:"Explore ideas with an AI agent before creating a formal plan",value:"brainstorm"},{label:"\u{1F4DD} Create Plan Directly",description:"Create a formal plan with title, description, and category",value:"create"}],{placeHolder:"How would you like to start?"});if(!f)return;if(f.value==="brainstorm"){let E=await u.window.showInputBox({prompt:"What would you like to brainstorm?",placeHolder:"Describe the feature, problem, or idea you want to explore...",validateInput:g=>g.trim()?null:"Please enter a description"});if(!E)return;try{await u.commands.executeCommand("workbench.action.chat.open",{query:`@brainstorm ${E}`})}catch{await u.window.showInformationMessage("Open GitHub Copilot Chat and use @brainstorm agent with your prompt.","Copy Prompt")==="Copy Prompt"&&(await u.env.clipboard.writeText(`@brainstorm ${E}`),q("Prompt copied to clipboard"))}return}let v=await u.window.showInputBox({prompt:"Enter plan title",placeHolder:"My new feature...",validateInput:E=>E.trim()?null:"Title is required"});if(!v)return;let y=await u.window.showInputBox({prompt:"Enter plan description",placeHolder:"Describe what this plan will accomplish, the goals, and any context...",validateInput:E=>E.trim().length>=10?null:"Please provide at least a brief description (10+ characters)"});if(!y)return;let x=E=>E?E.split(/[,\n]+/).map(g=>g.trim()).filter(g=>g.length>0):[],A=[];try{let E=await fetch(`http://localhost:${r}/api/plans/templates`);if(E.ok){let g=await E.json();A=Array.isArray(g.templates)?g.templates:[]}}catch{}A.length===0&&(A=[{template:"feature",label:"Feature",category:"feature"},{template:"bugfix",label:"Bug Fix",category:"bug"},{template:"refactor",label:"Refactor",category:"refactor"},{template:"documentation",label:"Documentation",category:"documentation"},{template:"analysis",label:"Analysis",category:"analysis"},{template:"investigation",label:"Investigation",category:"investigation"}]);let R=await u.window.showQuickPick([{label:"Custom",description:"Choose category and define your own steps",value:"custom"},...A.map(E=>({label:E.label||E.template,description:E.category||E.template,value:E.template}))],{placeHolder:"Select a plan template (optional)"});if(!R)return;let P=R.value!=="custom"?R.value:null,F=null,I=[],C=[];if(!P){let E=await u.window.showQuickPick([{label:"\u2728 Feature",description:"New functionality or capability",value:"feature"},{label:"\u{1F41B} Bug",description:"Fix for an existing issue",value:"bug"},{label:"\u{1F504} Change",description:"Modification to existing behavior",value:"change"},{label:"\u{1F50D} Analysis",description:"Investigation or research task",value:"analysis"},{label:"\u{1F9EA} Investigation",description:"Deep-dive analysis with findings",value:"investigation"},{label:"\u{1F41E} Debug",description:"Debugging session for an issue",value:"debug"},{label:"\u267B\uFE0F Refactor",description:"Code improvement without behavior change",value:"refactor"},{label:"\u{1F4DA} Documentation",description:"Documentation updates",value:"documentation"}],{placeHolder:"Select plan category"});if(!E)return;F=E.value}let W=await u.window.showQuickPick([{label:"\u{1F534} Critical",description:"Urgent - needs immediate attention",value:"critical"},{label:"\u{1F7E0} High",description:"Important - should be done soon",value:"high"},{label:"\u{1F7E1} Medium",description:"Normal priority",value:"medium"},{label:"\u{1F7E2} Low",description:"Nice to have - when time permits",value:"low"}],{placeHolder:"Select priority level"});if(!W)return;if(!P&&F==="investigation"){let E=await u.window.showInputBox({prompt:"Enter investigation goals (comma-separated)",placeHolder:"Identify root cause, confirm scope"});I=x(E);let g=await u.window.showInputBox({prompt:"Enter success criteria (comma-separated)",placeHolder:"Root cause identified, resolution path defined"});if(C=x(g),I.length===0||C.length===0){u.window.showErrorMessage("Investigation plans require at least 1 goal and 1 success criteria.");return}}let _=l[0].uri.fsPath,T=await yc(r,_);if(!T){u.window.showErrorMessage("Failed to register workspace with the dashboard server.");return}try{let E={title:v,description:y,priority:W.value,goals:I.length>0?I:void 0,success_criteria:C.length>0?C:void 0},g=P?await fetch(`http://localhost:${r}/api/plans/${T}/template`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({...E,template:P})}):await fetch(`http://localhost:${r}/api/plans/${T}`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({...E,category:F})});if(g.ok){let N=await g.json(),$=N.plan_id||N.plan?.id||N.plan?.plan_id||N.planId;q(`Plan created: ${v}`,"Open Dashboard").then(Q=>{Q==="Open Dashboard"&&$&&u.commands.executeCommand("projectMemory.openDashboardPanel",`http://localhost:5173/workspace/${T}/plan/${$}`)})}else{let N=await g.text();u.window.showErrorMessage(`Failed to create plan: ${N}`)}}catch(E){u.window.showErrorMessage(`Failed to create plan: ${E}`)}}),u.commands.registerCommand("projectMemory.deployAgents",async()=>{let l=u.workspace.workspaceFolders;if(!l){u.window.showErrorMessage("No workspace folder open");return}let f=u.workspace.getConfiguration("projectMemory"),v=f.get("agentsRoot"),y=v||Ne(),x=f.get("instructionsRoot")||jt(),A=f.get("defaultAgents")||[],R=f.get("defaultInstructions")||[];if(console.log("[ProjectMemory] Deploy Agents - Config agentsRoot:",v),console.log("[ProjectMemory] Deploy Agents - Resolved agentsRoot:",y),console.log("[ProjectMemory] Deploy Agents - Default fallback would be:",Ne()),!y){u.window.showErrorMessage("Agents root not configured. Set projectMemory.agentsRoot in settings.");return}let P=l[0].uri.fsPath,F=require("fs"),I=require("path");try{let C=F.readdirSync(y).filter($=>$.endsWith(".agent.md"));if(C.length===0){u.window.showWarningMessage("No agent files found in agents root");return}let W=C.map($=>{let Q=$.replace(".agent.md","");return{label:Q,description:$,picked:A.length===0||A.includes(Q)}}),_=await u.window.showQuickPick(W,{canPickMany:!0,placeHolder:"Select agents to deploy",title:"Deploy Agents"});if(!_||_.length===0)return;let T=I.join(P,".github","agents");F.mkdirSync(T,{recursive:!0});let E=0;for(let $ of _){let Q=`${$.label}.agent.md`,m=I.join(y,Q),w=I.join(T,Q);F.copyFileSync(m,w),E++}let g=0;if(x&&R.length>0){let $=I.join(P,".github","instructions");F.mkdirSync($,{recursive:!0});for(let Q of R){let m=`${Q}.instructions.md`,w=I.join(x,m),J=I.join($,m);F.existsSync(w)&&(F.copyFileSync(w,J),g++)}}le.postMessage({type:"deploymentComplete",data:{type:"agents",count:E,instructionsCount:g,targetDir:T}});let N=g>0?`\u2705 Deployed ${E} agent(s) and ${g} instruction(s)`:`\u2705 Deployed ${E} agent(s)`;q(N,"Open Folder").then($=>{$==="Open Folder"&&u.commands.executeCommand("revealInExplorer",u.Uri.file(T))})}catch(C){u.window.showErrorMessage(`Failed to deploy agents: ${C}`)}}),u.commands.registerCommand("projectMemory.deployPrompts",async()=>{let l=u.workspace.workspaceFolders;if(!l){u.window.showErrorMessage("No workspace folder open");return}let f=u.workspace.getConfiguration("projectMemory"),v=f.get("promptsRoot")||Xo(),y=f.get("defaultPrompts")||[];if(!v){u.window.showErrorMessage("Prompts root not configured. Set projectMemory.promptsRoot in settings.");return}let x=l[0].uri.fsPath,A=require("fs"),R=require("path");try{let P=A.readdirSync(v).filter(_=>_.endsWith(".prompt.md"));if(P.length===0){u.window.showWarningMessage("No prompt files found in prompts root");return}let F=P.map(_=>{let T=_.replace(".prompt.md","");return{label:T,description:_,picked:y.length===0||y.includes(T)}}),I=await u.window.showQuickPick(F,{canPickMany:!0,placeHolder:"Select prompts to deploy",title:"Deploy Prompts"});if(!I||I.length===0)return;let C=R.join(x,".github","prompts");A.mkdirSync(C,{recursive:!0});let W=0;for(let _ of I){let T=`${_.label}.prompt.md`,E=R.join(v,T),g=R.join(C,T);A.copyFileSync(E,g),W++}le.postMessage({type:"deploymentComplete",data:{type:"prompts",count:W,targetDir:C}}),q(`\u2705 Deployed ${W} prompt(s) to ${R.relative(x,C)}`,"Open Folder").then(_=>{_==="Open Folder"&&u.commands.executeCommand("revealInExplorer",u.Uri.file(C))})}catch(P){u.window.showErrorMessage(`Failed to deploy prompts: ${P}`)}}),u.commands.registerCommand("projectMemory.deployInstructions",async()=>{let l=u.workspace.workspaceFolders;if(!l){u.window.showErrorMessage("No workspace folder open");return}let f=u.workspace.getConfiguration("projectMemory"),v=f.get("instructionsRoot")||jt(),y=f.get("defaultInstructions")||[];if(!v){u.window.showErrorMessage("Instructions root not configured. Set projectMemory.instructionsRoot in settings.");return}let x=l[0].uri.fsPath,A=require("fs"),R=require("path");try{let P=A.readdirSync(v).filter(_=>_.endsWith(".instructions.md"));if(P.length===0){u.window.showWarningMessage("No instruction files found in instructions root");return}let F=P.map(_=>{let T=_.replace(".instructions.md","");return{label:T,description:_,picked:y.length===0||y.includes(T)}}),I=await u.window.showQuickPick(F,{canPickMany:!0,placeHolder:"Select instructions to deploy",title:"Deploy Instructions"});if(!I||I.length===0)return;let C=R.join(x,".github","instructions");A.mkdirSync(C,{recursive:!0});let W=0;for(let _ of I){let T=`${_.label}.instructions.md`,E=R.join(v,T),g=R.join(C,T);A.copyFileSync(E,g),W++}le.postMessage({type:"deploymentComplete",data:{type:"instructions",count:W,targetDir:C}}),q(`\u2705 Deployed ${W} instruction(s) to ${R.relative(x,C)}`,"Open Folder").then(_=>{_==="Open Folder"&&u.commands.executeCommand("revealInExplorer",u.Uri.file(C))})}catch(P){u.window.showErrorMessage(`Failed to deploy instructions: ${P}`)}}),u.commands.registerCommand("projectMemory.deployCopilotConfig",async()=>{let l=u.workspace.workspaceFolders;if(!l){u.window.showErrorMessage("No workspace folder open");return}await u.window.showQuickPick(["Yes","No"],{placeHolder:"Deploy all Copilot config (agents, prompts, instructions)?"})==="Yes"&&(le.postMessage({type:"deployAllCopilotConfig",data:{workspacePath:l[0].uri.fsPath}}),q("Deploying all Copilot configuration..."))}),u.commands.registerCommand("projectMemory.deployDefaults",async()=>{let l=u.workspace.workspaceFolders;if(!l){u.window.showErrorMessage("No workspace folder open");return}let f=nt.getDeploymentPlan();if(await u.window.showQuickPick(["Yes","No"],{placeHolder:`Deploy ${f.agents.length} agents and ${f.instructions.length} instructions?`})==="Yes"){let y=await nt.deployToWorkspace(l[0].uri.fsPath);q(`Deployed ${y.agents.length} agents and ${y.instructions.length} instructions`)}}),u.commands.registerCommand("projectMemory.updateDefaults",async()=>{let l=u.workspace.workspaceFolders;if(!l){u.window.showErrorMessage("No workspace folder open");return}let f=await nt.updateWorkspace(l[0].uri.fsPath);f.updated.length>0||f.added.length>0?q(`Updated ${f.updated.length} files, added ${f.added.length} new files`):q("All files are up to date")}),u.commands.registerCommand("projectMemory.openAgentFile",async()=>{let f=u.workspace.getConfiguration("projectMemory").get("agentsRoot")||Ne();if(!f){u.window.showErrorMessage("Agents root not configured");return}let v=require("fs"),y=require("path");try{let x=v.readdirSync(f).filter(R=>R.endsWith(".agent.md")),A=await u.window.showQuickPick(x,{placeHolder:"Select an agent file to open"});if(A){let R=y.join(f,A),P=await u.workspace.openTextDocument(R);await u.window.showTextDocument(P)}}catch(x){u.window.showErrorMessage(`Failed to list agent files: ${x}`)}}),u.commands.registerCommand("projectMemory.openPromptFile",async()=>{let f=u.workspace.getConfiguration("projectMemory").get("promptsRoot");if(!f){u.window.showErrorMessage("Prompts root not configured. Set projectMemory.promptsRoot in settings.");return}let v=require("fs"),y=require("path");try{let x=v.readdirSync(f).filter(R=>R.endsWith(".prompt.md")),A=await u.window.showQuickPick(x,{placeHolder:"Select a prompt file to open"});if(A){let R=y.join(f,A),P=await u.workspace.openTextDocument(R);await u.window.showTextDocument(P)}}catch(x){u.window.showErrorMessage(`Failed to list prompt files: ${x}`)}}),u.commands.registerCommand("projectMemory.showCopilotStatus",()=>{le.postMessage({type:"showCopilotStatus"}),u.commands.executeCommand("workbench.view.extension.projectMemory")}),u.commands.registerCommand("projectMemory.refreshData",()=>{le.postMessage({type:"refresh"})}),u.commands.registerCommand("projectMemory.openFile",async(l,f)=>{try{let v=await u.workspace.openTextDocument(l),y=await u.window.showTextDocument(v);if(f!==void 0){let x=new u.Position(f-1,0);y.selection=new u.Selection(x,x),y.revealRange(new u.Range(x,x),u.TextEditorRevealType.InCenter)}}catch{u.window.showErrorMessage(`Failed to open file: ${l}`)}}),u.commands.registerCommand("projectMemory.addToPlan",async l=>{let f,v,y;if(l)f=l.fsPath;else{let P=u.window.activeTextEditor;if(P){f=P.document.uri.fsPath;let F=P.selection;F.isEmpty||(v=P.document.getText(F),y=F.start.line+1)}}if(!f){u.window.showErrorMessage("No file selected");return}if(!u.workspace.workspaceFolders){u.window.showErrorMessage("No workspace folder open");return}let A=await u.window.showInputBox({prompt:"Describe the step/task for this file",placeHolder:"e.g., Review and update authentication logic",value:v?`Review: ${v.substring(0,50)}...`:`Work on ${require("path").basename(f)}`});if(!A)return;let R=await u.window.showQuickPick(["investigation","research","analysis","planning","implementation","testing","validation","review","documentation","refactor","bugfix","handoff"],{placeHolder:"Select the phase for this step"});R&&(le.postMessage({type:"addStepToPlan",data:{task:A,phase:R,file:f,line:y,notes:v?`Selected code:
\`\`\`
${v.substring(0,500)}
\`\`\``:void 0}}),q(`Added step to plan: "${A}"`))})),n&&(ot=new $t(n,e.get("autoDeployAgents")||!1),ot.start(),s.subscriptions.push({dispose:()=>ot.stop()})),Be=new Mt({agentsRoot:n,promptsRoot:o,instructionsRoot:i,autoDeploy:e.get("autoDeployAgents")||!1}),Be.start(),Be.onFileChanged((l,f,v)=>{v==="change"&&Gs.showTemporaryMessage(`${l} updated`)}),s.subscriptions.push({dispose:()=>Be.stop()}),Gs=new Ft,s.subscriptions.push(Gs),s.subscriptions.push(u.workspace.onDidChangeConfiguration(l=>{if(l.affectsConfiguration("projectMemory")){let f=u.workspace.getConfiguration("projectMemory");le.updateConfig(f.get("dataRoot")||Qo(),f.get("agentsRoot")||Ne())}})),console.log("Project Memory Dashboard extension activated")}async function _c(){console.log("Project Memory Dashboard extension deactivating..."),de&&(await de.disconnect(),de.dispose(),de=null),Re&&(Re.dispose(),Re=null),Ee&&(Ee.dispose(),Ee=null),le&&le.dispose(),ot&&ot.stop(),Be&&Be.stop(),H&&(await H.stopFrontend(),await H.stop(),await H.forceStopOwnedServer()),console.log("Project Memory Dashboard extension deactivated")}function Qo(){let s=u.workspace.workspaceFolders;if(s){let e=oe(s[0].uri.fsPath);return e?rt.join(e.projectPath,"data"):u.Uri.joinPath(s[0].uri,"data").fsPath}return""}function Ne(){let s=u.workspace.workspaceFolders;if(s){let e=oe(s[0].uri.fsPath);return e?rt.join(e.projectPath,"agents"):u.Uri.joinPath(s[0].uri,"agents").fsPath}return""}function jt(){let s=u.workspace.workspaceFolders;if(s){let e=oe(s[0].uri.fsPath);return e?rt.join(e.projectPath,"instructions"):u.Uri.joinPath(s[0].uri,"instructions").fsPath}return""}function Xo(){let s=u.workspace.workspaceFolders;if(s){let e=oe(s[0].uri.fsPath);return e?rt.join(e.projectPath,"prompts"):u.Uri.joinPath(s[0].uri,"prompts").fsPath}return""}function kc(s,e,t){let n=e.get("chat.serverMode")||"bundled",o=e.get("chat.podmanImage")||"project-memory-mcp:latest",i=e.get("chat.externalServerPath")||"",r=e.get("chat.autoConnect")??!0;de=new et({serverMode:n,podmanImage:o,externalServerPath:i,dataRoot:t}),s.subscriptions.push(de),de.onConnectionChange(a=>{a&&(Re?.resetWorkspace(),Ee?.resetWorkspace())}),Re=new tt(de),s.subscriptions.push(Re),Ee=new st(de),s.subscriptions.push(Ee),s.subscriptions.push(u.commands.registerCommand("projectMemory.chat.reconnect",async()=>{if(!de){u.window.showErrorMessage("MCP Bridge not initialized");return}try{await u.window.withProgress({location:u.ProgressLocation.Notification,title:"Reconnecting to MCP server...",cancellable:!1},async()=>{await de.reconnect()}),q("Connected to MCP server")}catch(a){let c=a instanceof Error?a.message:String(a);u.window.showErrorMessage(`Failed to connect: ${c}`),de.showLogs()}})),r&&de.connect().then(()=>{console.log("MCP Bridge connected")}).catch(a=>{console.warn("MCP Bridge auto-connect failed:",a)}),s.subscriptions.push(u.workspace.onDidChangeConfiguration(a=>{a.affectsConfiguration("projectMemory.chat")&&q("Chat configuration changed. Some changes may require reconnecting.","Reconnect").then(c=>{c==="Reconnect"&&u.commands.executeCommand("projectMemory.chat.reconnect")})})),s.subscriptions.push(u.workspace.onDidChangeWorkspaceFolders(()=>{Re?.resetWorkspace(),Ee?.resetWorkspace()})),console.log("Chat integration initialized")}0&&(module.exports={activate,deactivate});
