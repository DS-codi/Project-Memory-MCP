 ...
 */
function getClientScript(params) {
    const { apiPort, dashboardUrl, workspaceId, workspaceName, dataRoot, iconsJson, iconSvgs, } = params;
    const connectedHtml = (0, sections_1.getConnectedDashboardHtml)(iconSvgs, apiPort, workspaceName);
    const disconnectedHtml = (0, sections_1.getDisconnectedFallbackHtml)();
    const helpers = (0, client_helpers_1.getClientHelpers)();
    const skillsHelpers = (0, skills_section_1.getSkillsClientHelpers)();
    const instructionsHelpers = (0, instructions_section_1.getInstructionsClientHelpers)();
    const sessionsHelpers = (0, sessions_section_1.getSessionsClientHelpers)();
    return `
