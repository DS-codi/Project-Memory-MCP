...
exports.clearIdentityCache = clearIdentityCache;
exports.resolveWorkspaceIdentity = resolveWorkspaceIdentity;
exports.computeFallbackWorkspaceId = computeFallbackWorkspaceId;
...
function collectCanonicalAndLegacy(entry, registeredIds, legacyToCanonical) {
...
function isParentOrChildPath(a, b) {
    if (!a || !b)
        return false;
...
function canonicalizeWorkspaceId(parsed) {
    ...
    try {
        ...
        const registryPathToCanonical = new Map();
