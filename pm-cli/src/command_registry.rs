...
impl CommandRegistry {
    ...
    pub fn build_phases(component: &str) -> Vec<(String, Vec<String>)> {
        match component {
            ...
            "SupervisorIced" => vec![
                ("Rust Build".to_string(), PowerShellFallback::build_args("scripts/cli-build-supervisor-iced.ps1",     &[])),
            ],
            "GuiForms" => vec![
            ...
            "GlobalClaude" => vec![
                ("Install".to_string(), PowerShellFallback::build_args("scripts/install-global-claude.ps1", &[])),
            ],
            _ => vec![],
        }
    }
        ...
        match cmd {
            ...
            "install" => {
                ...
                let targets: Vec<String> = if component == "All" {
                    vec!["Supervisor", "SupervisorIced", "GuiForms", "InteractiveTerminal", "Server",
                         "Dashboard", "Extension", "Cartographer", "GlobalClaude"]
